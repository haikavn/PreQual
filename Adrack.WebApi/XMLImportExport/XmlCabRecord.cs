...
namespace Adrack.WebApi.XMLImportExport
{
	...
	/// </summary>
	public class XmlCabRecord 
	{
		public XmlCabRecord(FILE_IN_CABINET_INFO fileInCabinetInfo)
		{
		...
		public override bool Equals(object obj)
		{
			...
			XmlCabRecord other = (XmlCabRecord)obj;
			return ( string.Compare(this.Path, other.Path, true) == 0 && string.Compare(this.Name, other.Name, true)==0);
		}

		public static bool operator ==(XmlCabRecord a, XmlCabRecord b)
		{
