...
namespace Adrack.WebApi.PdfBuilder.HighCharts
{
    ...
    public class HighchartsExporter
    {
        ...
        public async Task<string> GetImageBytesFromOptions_Works(dynamic _options)
        {
            ...
            var res = await client.GetChartImageFromOptionsAsync(JsonConvert.SerializeObject(_options));

            var str = _highchartsServer + "/" + new ASCIIEncoding().GetString(res);
            return str;
