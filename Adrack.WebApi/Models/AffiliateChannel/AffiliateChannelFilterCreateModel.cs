...
{
    public class AffiliateChannelFilterCreateModel
    {
        public long? Id { get; set; }
        public List<FilterConditionValueModel> Values { get; set; }

        public List<AffiliateChannelSubFilterModel> Children { get; set; }
        ...
        public static explicit operator AffiliateChannelFilterCondition(AffiliateChannelFilterCreateModel affiliateChannelFilter)
        {
