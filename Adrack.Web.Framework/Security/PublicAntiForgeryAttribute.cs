...
// ***********************************************************************
// <copyright file="PublicAntiForgeryAttribute.cs" company="Adrack.com">
//     Copyright © 2019
// </copyright>
// <summary></summary>
// ***********************************************************************
...
{
    /// <summary>
    /// Represents a Public Anti Forgery Attribute
    ...
    public class PublicAntiForgeryAttribute : FilterAttribute, IAuthorizationFilter
    {
        ...
        /// <summary>
        /// Public Anti Forgery Attribute
        /// </summary>
        /// <param name="validate">Validate</param>
        public PublicAntiForgeryAttribute(bool validate = false)
        {
        ...
        public void OnAuthorization(AuthorizationContext authorizationContext)
        {
            ...
            if (!securitySetting.PublicXsrfProtection)
                return;
