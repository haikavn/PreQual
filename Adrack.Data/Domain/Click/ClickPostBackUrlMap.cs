...
namespace Adrack.Data.Domain.Click
{
    ...
    public partial class ClickPostBackUrlMap : AppEntityTypeConfiguration<ClickPostBackUrl>
    {
        #region Constructor


        public ClickPostBackUrlMap() // elite group
        {
            this.ToTable("ClickPostBackUrl");
