    ...
    function (e) {
        ...
        function () {
                ...
                for (var c = function () {
                    ...
                    for (var h = 0; h < e[l].data.length; h++) {
                        ...
                        for (var k, _ = 0, V = 0; V < e[l].data[h].evolution.length; V++)
                            k = e[l].data[h].evolution[V], f.time.push(k.timeScale), f.value.push(k.valueScale), _ =
                                Math.max(_, k.valueScale);
                        n(f, i, U), f.y = a(u, f, function (e, t) { return e.ypx[t] }), f._offset =
                            a(c, f, function () { return s }), g = Math.max(g, f.y + _), b =
                            Math.max(b, f._offset), y.push(f);
                    }
                t(y, o, g, b);
            }

            function t(e, t, i, n) {
                for (var a = t.height, o = n / a > .5 ? .5 : 1, r = t.y, s = (t.height - n) / i, l = 0, h = e.length;
                    h > l;
                    l++) {
                    var m = e[l];
                    m.y = r + s * m.y + m._offset * o, delete m.time, delete m.value, delete m.xpx, delete m.ypx, delete
                        m._offset;
            ...
            function i(e, t, i, n) {
                ...
                if (t === n) return function () { return t };
                var a = (t - n) / (e - i), o = (n * e - t * i) / (e - i);
                return function (e) { return a * e + o };
            }
