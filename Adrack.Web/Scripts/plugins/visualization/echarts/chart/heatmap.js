define("echarts/chart/heatmap",
    [
        "require", "./base", "../layer/heatmap", "../config", "../util/ecData", "zrender/tool/util",
    ...
    function (e) {
        ...
        return a.heatmap = { zlevel: 0, z: 2, clickable: !0 }, t.prototype = {
            ...
            refresh: function (e) { this.clear(), e && (this.option = e, this.series = e.series), this._init() },
            _init: function () {
                var e = this.series;
                    ...
                    if (!this._gradientPixels) {
                        ...
                        for (var i = t.getContext("2d"),
                            ...
                            "string" == typeof this.option.gradientColors[r]
                                ...
                                : a.addColorStop(this.option.gradientColors[r].offset, this.option.gradientColors[r].color);
