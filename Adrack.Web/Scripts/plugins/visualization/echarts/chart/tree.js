define("echarts/chart/tree",
    [
        "require", "./base", "../util/shape/Icon", "zrender/shape/Image", "zrender/shape/Line",
        "zrender/shape/BezierCurve", "../layout/Tree", "../data/Tree", "../config", "../util/ecData", "zrender/config",
        ...
        return t.prototype = {
            ...
            _buildBezierCurve: function (e, t, i, a) {
                ...
                if ("horizontal" === r) d = (m - l) * o + l, p = h, c = (m - l) * (1 - o) + l, u = V;
                    ...
                    if (e.id === this.tree.root.id)
                        ...
                        d = p * Math.cos(x) + k, p = p * Math.sin(x) + _, x =
                            (c - this.minX) / this.width * Math.PI * 2, c = u * Math.cos(x) + k, u =
                            u * Math.sin(x) + _;
                    }
                var L = new s({
                    zlevel: this.getZlevelBase(),
            ...
            _setTreeShape: function (e) {
                ...
                var i = e.orient,
                    ...
                    o = this.zr.getWidth(),
                    r = this.zr.getHeight();
                n = "center" === n ? .5 * o : this.parsePercent(n, o), a =
                    "center" === a ? .5 * r : this.parsePercent(a, r), a =
                    this.parsePercent(a, r), "horizontal" === i &&
                    (n = isNaN(n) ? 10 : n, a = isNaN(a) ? .5 * r : a),
                    "radial" === i
                        ? (n = isNaN(n) ? .5 * o : n, a = isNaN(a) ? .5 * r : a)
                        : (n = isNaN(n) ? .5 * o : n, a = isNaN(a) ? 10 : a);
