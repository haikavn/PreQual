define("echarts/chart/map",
    [
        "require", "./base", "zrender/shape/Text", "zrender/shape/Path", "zrender/shape/Circle",
        "zrender/shape/Rectangle", "zrender/shape/Line", "zrender/shape/Polygon", "zrender/shape/Ellipse",
        "zrender/shape/Image", "../component/dataRange", "../component/roamController", "../layer/heatmap",
        "../config",
        "../util/ecData", "zrender/tool/util", "zrender/config", "zrender/tool/event", "../util/mapData/params",
        "../util/mapData/textFixed", "../util/mapData/geoCoord", "../util/projection/svg",
    ...
    function (e) {
        function t(e, t, n, a, o) {
            ...
            var r = this;
            r._onmousewheel = function (e) { return r.__onmousewheel(e) }, r._onmousedown =
                function (e) { return r.__onmousedown(e) }, r._onmousemove =
                function (e) { return r.__onmousemove(e) }, r._onmouseup =
                function (e) { return r.__onmouseup(e) }, r._onroamcontroller =
                function (e) { return r.__onroamcontroller(e) }, r._ondrhoverlink =
                function (e) { return r.__ondrhoverlink(e) }, this._isAlive = !0, this._selectedMode =
                {}, this._activeMapType = {}, this._clickable = {}, this._hoverable =
                {}, this._showLegendSymbol =
                {}, this._selected = {}, this._mapTypeMap = {}, this._mapDataMap = {}, this._nameMap =
                {}, this._specialArea =
                {}, this._refreshDelayTicket, this._mapDataRequireCounter, this._markAnimation =
                !1, this._hoverLinkMap = {}, this._roamMap = {}, this._scaleLimitMap =
                {}, this._mx, this._my, this._mousedown, this._justMove, this._curMapType, this.refresh(a),
                this.zr.on(c.EVENT.MOUSEWHEEL, this._onmousewheel),
                this.zr.on(c.EVENT.MOUSEDOWN, this._onmousedown),
                t.bind(U.EVENT.ROAMCONTROLLER, this._onroamcontroller), t.bind(U.EVENT.DATA_RANGE_HOVERLINK,
                    this._ondrhoverlink);
        }
        ...
        return t.prototype = {
            ...
            _buildShape: function () {
                ...
                for
                    (var t, i, n, a, o = this.component.legend, r = {}, s = {}, l = {}, h = {}, m = 0, V = e.length;
                    V > m;
                    m++)
                    if (e[m].type == U.CHART_TYPE_MAP &&
                        (e[m] = this.reformOption(e[m]), i = e[m].mapType, s[i] = s[i] || {}, s[i][m] = !0, l[i] =
                            l[i] || e[m].mapValuePrecision, this._scaleLimitMap[i] =
                            this._scaleLimitMap[i] || {},
                            e[m].scaleLimit && p.merge(this._scaleLimitMap[i], e[m].scaleLimit, !0), this._roamMap[i] =
                            e[m].roam || this._roamMap[i],
                            (null == this._hoverLinkMap[i] || this._hoverLinkMap[i]) &&
                            (this._hoverLinkMap[i] = e[m].dataRangeHoverLink), this._nameMap[i] =
                            this._nameMap[i] || {}, e[m].nameMap && p.merge(this._nameMap[i], e[m].nameMap, !0),
                            this._activeMapType[i] =
                            !0, e[m].textFixed && p.merge(g, e[m].textFixed, !0),
                            e[m].geoCoord && p.merge(b, e[m].geoCoord, !0), this._selectedMode[i] =
                            this._selectedMode[i] || e[m].selectedMode,
                            (null == this._hoverable[i] || this._hoverable[i]) && (this._hoverable[i] = e[m].hoverable),
                            (null == this._clickable[i] || this._clickable[i]) && (this._clickable[i] = e[m].clickable),
                            (null == this._showLegendSymbol[i] || this._showLegendSymbol[i]) &&
                            (this._showLegendSymbol[i] = e[m].showLegendSymbol), h[i] =
                            h[i] || e[m].mapValueCalculation, t = e[m].name, this.selectedMap[t] =
                            o ? o.isSelected(t) : !0, this.selectedMap[t])) {
                        r[i] = r[i] || {}, n = e[m].data;
                        for (var d = 0, c = n.length; c > d; d++) {
                            a = this._nameChange(i, n[d].name), r[i][a] =
                                r[i][a] || { seriesIndex: [], valueMap: {}, precision: 0 };
                            for (var u in n[d])
                                "value" != u
                                    ? r[i][a][u] = n[d][u]
                                    : isNaN(n[d].value) ||
                                    (null == r[i][a].value && (r[i][a].value = 0), r[i][a].precision =
                                        Math.max(this.getPrecision(+n[d].value), r[i][a].precision),
                                        r[i][a].value += +
                                        n[d].value, r[i][a].valueMap[m] = +n[d].value);
                ...
                this._clearSelected(), 0 === this._mapDataRequireCounter &&
                    (this.clear(), this.zr && this.zr.delShape(this.lastShapeList), this.lastShapeList = []);
                for (var f in r) {
                    for (var c in r[f]) {
                    ...
                    this._mapDataMap[f] = this._mapDataMap[f] || {}, this._mapDataMap[f].mapData
                        ...
                        (this._specialArea[f] =
                            y[f.replace(/\|.*/, "")].specialArea || this._specialArea[f], y[f.replace(/\|.*/, "")]
                                .getGeoJson(this._mapDataCallback(f, r[f], s[f])));
                }
            },
            _mapDataCallback: function (t, i, n) {
                ...
                return function (o) {
                    a._isAlive &&
                        ...
                        (-1 != t.indexOf("|") && (o = a._getSubMapData(t, o)), a._mapDataMap[t].mapData =
                            o, o.firstChild
                                ? (a._mapDataMap[t].rate = 1, a._mapDataMap[t].projection =
                                    e("../util/projection/svg"))
                                : (a._mapDataMap[t].rate = .75, a._mapDataMap[t].projection =
                                    e("../util/projection/normal")), a._buildMap(t,
                                        a._getProjectionData(t, o, n),
                                        i,
                                        n),
                            a._buildMark(t, n), --a._mapDataRequireCounter <= 0 &&
                            (a.addShapeList(), a.zr.refreshNextFrame()), a._buildHeatmap(t));
                };
            },
            ...
            _getProjectionData: function (e, t, i) {
                ...
                n.left != l.left || n.top != l.top || n.scale.x != l.scale.x || n.scale.y != l.scale.y
                    ? (s = a.geoJson2Path(t, n, this._specialArea[e]), l = p.clone(n))
                    : (n = this._mapDataMap[e].transform, s = this._mapDataMap[e].pathArray), this._mapDataMap[e]
                        .bbox =
                    r, this._mapDataMap[e].transform = n, this._mapDataMap[e].lastTransform =
                    l, this._mapDataMap[e].pathArray = s;
            ...
            _getTransform: function (e, t, i) {
                ...
                for (var p in t)
                    n = m[p].mapLocation || {}, o = n.x || o, s = n.y || s, l = n.width || l, h = n.height || h;
                a = this.parsePercent(o, V), a = isNaN(a) ? d : a, r = this.parsePercent(s, U), r =
                    isNaN(r) ? d : r, l = null == l ? V - a - 2 * d : this.parsePercent(l, V), h =
                    null == h ? U - r - 2 * d : this.parsePercent(h, U);
            ...
            _buildMap: function (e, t, i, m) {
                for (var V,
                    ...
                    w > K;
                    K++) {
                    if (k = p.clone(t[K]), _ = { name: k.name, path: k.path, position: p.clone(k.position) }, c =
                        k.name, u = i[c]) {
                        g = [u], V = "";
                    ...
                    switch (this.ecTheme.map && g.push(this.ecTheme.map), g.push(U.map), b =
                    v && !isNaN(y) ? v.getColor(y) : null, k.color =
                    k.color ||
                    b ||
                    this.getItemStyleColor(this.deepQuery(g, "itemStyle.normal.color"), u.seriesIndex, -1, u) ||
                    this.deepQuery(g, "itemStyle.normal.areaStyle.color"), k.strokeColor =
                    k.strokeColor || this.deepQuery(g, "itemStyle.normal.borderColor"), k.lineWidth =
                    k.lineWidth || this.deepQuery(g, "itemStyle.normal.borderWidth"), _.color =
                    this.getItemStyleColor(this.deepQuery(g, "itemStyle.emphasis.color"),
                        u.seriesIndex,
                        -1,
                        u) ||
                    this.deepQuery(g, "itemStyle.emphasis.areaStyle.color") ||
                    k.color, _.strokeColor =
                    this.deepQuery(g, "itemStyle.emphasis.borderColor") || k.strokeColor, _.lineWidth =
                    this.deepQuery(g, "itemStyle.emphasis.borderWidth") || k.lineWidth, k.brushType =
                    _.brushType =
                    k.brushType || "both", k.lineJoin = _.lineJoin = "round", k._name = _._name = c, f =
                    this.deepQuery(g, "itemStyle.normal.label.textStyle"), L =
                    {
                        ...
                        style: {
                            ...
                            _name: c,
                            textAlign: "center",
                            color: this.deepQuery(g, "itemStyle.normal.label.show")
                                ? this.deepQuery(g, "itemStyle.normal.label.textStyle.color")
                                : "rgba(0,0,0,0)",
                            textFont: this.getFont(f)
                        }
                    }, L._style = p.clone(L.style), L.highlightStyle =
                    p.clone(L.style), this.deepQuery(g, "itemStyle.emphasis.label.show")
                        ? (L.highlightStyle.text = this.getLabelText(c, y, g, "emphasis"), L.highlightStyle.color =
                            this.deepQuery(g, "itemStyle.emphasis.label.textStyle.color") || L.style.color, f =
                            this.deepQuery(g, "itemStyle.emphasis.label.textStyle") || f,
                    ...
                    (this._selectedMode[e] && this._selected[c] && u.selected !== !1 || u.selected === !0) &&
                        (L.style = L.highlightStyle, x.style = x.highlightStyle), L.clickable = x.clickable =
                        this._clickable[e] && (null == u.clickable || u.clickable), this._selectedMode[e] &&
                        (this._selected[c] =
                            null != this._selected[c] ? this._selected[c] : u.selected, this._mapTypeMap[c] =
                            e, (null == u.selectable || u.selectable) &&
                            (x.clickable = L.clickable = !0, x.onclick = L.onclick = this.shapeHandler.onclick)),
                        this._hoverable[e] && (null == u.hoverable || u.hoverable)
                            ...
                            : L.hoverable = x.hoverable = !1, d.pack(L,
                                { name: V, tooltip: this.deepQuery(g, "tooltip") },
                                0,
                                u,
                                0,
                                c), this.shapeList.push(L), d.pack(x,
                                    { name: V, tooltip: this.deepQuery(g, "tooltip") },
                                    0,
                                    u,
                                    0,
                                    c), this.shapeList.push(x);
                }
            },
            _buildMark: function (e, t) {
                this._seriesIndexToMapType = this._seriesIndexToMapType || {}, this.markAttachStyle =
                    this.markAttachStyle || {};
                ...
                for (var n in t)
                    this._seriesIndexToMapType[n] = e, this.markAttachStyle[n] =
                        { position: i, _mapType: e }, this.buildMark(n);
            },
            ...
            getMarkCoord: function (e, t) {
                return t.geoCoord || b[t.name]
                    ? this.geo2pos(this._seriesIndexToMapType[e], t.geoCoord || b[t.name])
                    : [0, 0];
            },
            getMarkGeo: function (e) { return e.geoCoord || b[e.name] },
            ...
            getLabelText: function (e, t, i, n) {
                ...
                return a
                    ? "function" == typeof a
                        ...
                        : "string" == typeof a
                            ? (a = a.replace("{a}", "{a0}").replace("{b}", "{b0}"), a =
                                a.replace("{a0}", e).replace("{b0}", t))
                            : void 0
                    : e;
            },
            _findMapTypeByPos: function (e, t) {
                ...
                for (var s in this._mapDataMap)
                    if (i = this._mapDataMap[s].transform, i &&
                        ...
                        (n = i.left, a = i.top, o = i.width, r =
                            i.height, e >= n && n + o >= e && t >= a && a + r >= t)) return s;
            },
            __onmousewheel: function (e) {
                ...
                if (!(this.shapeList.length <= 0)) {
                        ...
                        if (d[s]) {
                            ...
                            if (V > 0) {
                                if (r = 1.2, null != this._scaleLimitMap[s].max &&
                                    c.baseScale >= this._scaleLimitMap[s].max) continue;
                            } else if (r = 1 / 1.2, null != this._scaleLimitMap[s].min &&
                                c.baseScale <= this._scaleLimitMap[s].min) continue;
                            c.baseScale *= r, c.scale.x *= r, c.scale.y *= r, c.width = b * r, c.height =
                                f * r, this._mapDataMap[s].hasRoam = !0, this._mapDataMap[s].transform = c, k =
                                this.geo2pos(s, k), c.left -= k[0] - (h - y), c.top -= k[1] - (m - g),
                                this._mapDataMap[s].transform = c, this.clearEffectShape(!0);
                            for (var n = 0, a = this.shapeList.length; a > n; n++) {
                                var o = this.shapeList[n];
                                if (o._mapType == s) {
                                    ...
                                    switch (o.position[0] = c.left, o.position[1] = c.top, _) {
                                        ...
                                        case "shape-bundle":
                                            for (var L = 0; L < x.shapeList.length; L++) {
                                                ...
                                                "mark-line" == W.type
                                                    ? i(W.style, r)
                                                    : "polyline" == W.type && t(W.style, r);
                                            }
                                            break;
                                        case "icon":
                                        case "image":
                                            k = this.geo2pos(s, o._geo), x.x = x._x = k[0] - x.width / 2, x.y = x._y =
                                                k[1] - x.height / 2;
                                            break;
                                        default:
                                            k = this.geo2pos(s, o._geo), x.x = k[0], x.y = k[1], "text" == _ &&
                                                (o._style.x = o.highlightStyle.x = k[0], o._style.y = o.highlightStyle.y =
                                                    k[1]);
                                    }
                    ...
                    if (p) {
                        ...
                        var X = this;
                        clearTimeout(this._refreshDelayTicket), this._refreshDelayTicket =
                            setTimeout(function () { X && X.shapeList && X.animationEffect() }, 100),
                            this.messageCenter.dispatch(U.EVENT.MAP_ROAM, e.event, { type: "scale" }, this.myChart);
                    }
                }
            },
                ...
                if (!(this.shapeList.length <= 0)) {
                    ...
                    if (!t || !t.draggable) {
                        ...
                        if (o && this._roamMap[o] && "scale" != this._roamMap[o]) {
                            this._mousedown = !0, this._mx = n, this._my = a, this._curMapType =
                                o, this.zr.on(c.EVENT.MOUSEUP, this._onmouseup);
                            var r = this;
                            setTimeout(function () { r.zr.on(c.EVENT.MOUSEMOVE, r._onmousemove) }, 100);
                        }
                    }
                }
            },
            __onmousemove: function (e) {
                if (this._mousedown && this._isAlive) {
                    ...
                    a.hasRoam = !0, a.left -= this._mx - i, a.top -= this._my - n, this._mx = i, this._my =
                        n, this._mapDataMap[this._curMapType].transform = a;
                    for (var o = 0, r = this.shapeList.length; r > o; o++)
                        this.shapeList[o]._mapType == this._curMapType &&
                            (this.shapeList[o].position[0] = a.left, this.shapeList[o].position[1] =
                                a.top, this.zr.modShape(this.shapeList[o].id));
                    this.messageCenter.dispatch(U.EVENT.MAP_ROAM, e.event, { type: "move" }, this.myChart),
                        this.clearEffectShape(!0), this.zr.refreshNextFrame(), this._justMove = !0, u.stop(t);
                }
            },
            __onmouseup: function (e) {
                ...
                var i = this;
                setTimeout(function () {
                    i._justMove && i.animationEffect(), i._justMove =
                        !1, i.zr.un(c.EVENT.MOUSEMOVE, i._onmousemove), i.zr.un(c.EVENT.MOUSEUP, i._onmouseup);
                },
                    120);
            },
            __onroamcontroller: function (e) {
                ...
                for (s in i)
                    this._mapDataMap[s] &&
                        this._activeMapType[s] &&
                        (r = this._mapDataMap[s].transform, r.hasRoam =
                            !0, r.left -= a, r.top -= n, this._mapDataMap[s].transform = r);
                for (var l = 0, h = this.shapeList.length; h > l; l++)
                    s = this.shapeList[l]._mapType, i[s] &&
                        this._activeMapType[s] &&
                        (r = this._mapDataMap[s].transform, this.shapeList[l].position[0] =
                            r.left, this.shapeList[l].position[1] = r.top, this.zr.modShape(this.shapeList[l].id));
                this.messageCenter.dispatch(U.EVENT.MAP_ROAM, e.event, { type: "move" }, this.myChart),
                    this.clearEffectShape(!0), this.zr.refreshNextFrame(), clearTimeout(this.dircetionTimer);
                var m = this;
                this.dircetionTimer = setTimeout(function () { m.animationEffect() }, 150);
            },
            ...
            onclick: function (e) {
                if (this.isClick && e.target && !this._justMove && "icon" != e.target.type) {
                                ...
                                for (var r = 0; n > r; r++)
                                    this.shapeList[r].style._name == o &&
                                        ...
                                        (this.shapeList[r].style =
                                            this.shapeList[r]._style, this.zr.modShape(this.shapeList[r].id));
                    ...
                    var s = this;
                    setTimeout(function () { s.zr.trigger(c.EVENT.MOUSEMOVE, e.event) }, 100);
                }
            },
            refresh: function (e) {
                e && (this.option = e, this.series = e.series), this._mapDataRequireCounter > 0
                    ? this.clear()
                    : this.backupShapeList(), this._buildShape(), this.zr.refreshHover();
            },
            ...
            pos2geo: function (e, t) {
                return this._mapDataMap[e].transform
                    ? this._mapDataMap[e].projection.pos2geo(this._mapDataMap[e].transform, t)
                    : null;
            },
            getGeoByPos: function (e, t) {
                if (!this._mapDataMap[e].transform) return null;
                var i = [this._mapDataMap[e].transform.left, this._mapDataMap[e].transform.top];
                return t instanceof Array ? (t[0] -= i[0], t[1] -= i[1]) : (t.x -= i[0], t.y -= i[1]), this.pos2geo(
                    e,
                    t);
            },
            geo2pos: function (e, t) {
                return this._mapDataMap[e].transform
                    ? this._mapDataMap[e].projection.geo2pos(this._mapDataMap[e].transform, t)
                    : null;
            },
            ...
            getMapPosition:
                function (e) {
                    return this._mapDataMap[e].transform
                        ? [this._mapDataMap[e].transform.left, this._mapDataMap[e].transform.top]
                        : null;
                },
            onbeforDispose: function () {
                this._isAlive =
                    !1, this.zr.un(c.EVENT.MOUSEWHEEL, this._onmousewheel),
                    this.zr.un(c.EVENT.MOUSEDOWN, this._onmousedown), this.messageCenter.unbind(
                        U.EVENT.ROAMCONTROLLER,
                        this._onroamcontroller), this.messageCenter.unbind(U.EVENT.DATA_RANGE_HOVERLINK,
                            this._ondrhoverlink);
            }
        ...
        function (e) {
            ...
            return s.prototype = {
                ...
                buildPathArray: function (e, t, i) {
                    ...
                    var a = e,
                        o = [
                            "m", "M", "l", "L", "v", "V", "h", "H", "z", "Z", "c", "C", "q", "Q", "t", "T", "s", "S",
                            "a",
                            "A"
                        ];
                                ...
                                case "S":
                                    c = h, u = m, y =
                                        ...
                                        (c = h + (h - y.points[2]), u = m + (m - y.points[3])), L.push(c,
                                            u,
                                            d.shift(),
                                            d.shift()), h = d.shift(), m = d.shift(), x = "C", L.push(h, m);
                                    break;
                                case "s":
                                    c = h, u = m, y =
                                        l[l.length - 1], "C" === y.command &&
                                        (c = h + (h - y.points[2]), u = m + (m - y.points[3])), L.push(c,
                                            u,
                                            h + d.shift(),
                                            m + d.shift()), h += d.shift(), m += d.shift(), x = "C", L.push(h, m);
                                    break;
                                case "Q":
                                    L.push(d.shift(), d.shift()), h = d.shift(), m = d.shift(), L.push(h, m);
                                    break;
                                case "q":
                                    L.push(h + d.shift(), m + d.shift()), h += d.shift(), m += d.shift(), x =
                                        "Q", L.push(h, m);
                                    break;
                                case "T":
                                    c = h, u = m, y =
                                        ...
                                        d.shift(), x = "Q", L.push(c, u, h, m);
                                    break;
                                case "t":
                                    c = h, u = m, y =
                                        l[l.length - 1], "Q" === y.command &&
                                        (c = h + (h - y.points[0]), u = m + (m - y.points[1])), h += d.shift(), m += d
                                            .shift(),
                                        x = "Q", L.push(c, u, h, m);
                                    break;
                                case "A":
                                    g = d.shift(), b = d.shift(), f = d.shift(), k = d.shift(), _ = d.shift(), W = h, X =
                                        m, h =
                                        d.shift(), m = d.shift(), x = "A", L =
                                        this._convertPoint(W, X, h, m, k, _, g, b, f);
                                    break;
                                case "a":
                                    g = d.shift(), b = d.shift(), f = d.shift(), k = d.shift(), _ = d.shift(), W = h, X =
                                        m, h += d.shift(), m += d.shift(), x = "A", L =
                                        this._convertPoint(W, X, h, m, k, _, g, b, f);
                            }
                ...
                _convertPoint: function (e, t, i, n, a, s, l, h, m) {
                    ...
                    var c = Math.sqrt((l * l * h * h - l * l * d * d - h * h * U * U) /
                        (l * l * d * d + h * h * U * U));
                    a === s && (c *= -1), isNaN(c) && (c = 0);
                    var u = c * l * d / h,
                        y = c * -h * U / l,
                        ...
                        _ = [(-1 * U - u) / l, (-1 * d - y) / h],
                        x = r(k, _);
                    return o(k, _) <= -1 && (x = Math.PI), o(k, _) >= 1 && (x = 0), 0 === s &&
                        x > 0 &&
                        (x -= 2 * Math.PI),
                        1 === s && 0 > x && (x += 2 * Math.PI), [g, b, l, h, f, x, V, s];
                },
                        ...
                        switch (d) {
                            ...
                            case "A":
                                var p = m[0],
                                    ...
                                    x = u > y ? 1 : u / y,
                                    L = u > y ? y / u : 1;
                                e.translate(p, c), e.rotate(f), e.scale(x, L), e.arc(0, 0, _, g, g + b, 1 - k), e.scale(
                                    1 / x,
            ...
            function (e) {
                ...
                return i.prototype = {
                    ...
                    buildPath: function (e, t) {
                        ...
                        e.moveTo(n - o, a), e.bezierCurveTo(n - o, a - l, n - s, a - r, n, a - r),
                            e.bezierCurveTo(n + s, a - r, n + o, a - l, n + o, a), e.bezierCurveTo(n + o,
                                a + l,
                                n + s,
                                a + r,
                                n,
                                a + r), e.bezierCurveTo(n - s, a + r, n - o, a + l, n - o, a), e.closePath();
                    },
                    getRect: function (e) {
                        if (e.__rect) return e.__rect;
                        var t;
                ...
                function (e) {
                    ...
                    return t.prototype = {
                        ...
                        _buildItem: function () {
                            ...
                            "vertical" == this.dataRangeOption.orient &&
                                ...
                                (m = this._itemGroupLocation.x + this._itemGroupLocation.width - U);
                            var u = !0;
                                ...
                                (u = !1, this.dataRangeOption.text[0] &&
                                    (i = this._getTextShape(m, V, this.dataRangeOption.text[0]),
                                        "horizontal" == this.dataRangeOption.orient
                                            ...
                                            : (V += c + this._textGap, i.style.y += c / 2 + this._textGap, i.style.textBaseline =
                                                "bottom"),
                                        this.shapeList.push(new n(i))));
                            for (var y = 0; s > y; y++)
                                e = r[y], o = this.getColorByIndex(y), t =
                                    this._getItemShape(m, V, U, d, this._selectedMap[y] ? o : "#ccc"), t._idx =
                                    y, t.onmousemove =
                                    ...
                                    "right" == this.dataRangeOption.x &&
                                        (i.style.x -= U + 10, i.style.textAlign = "right"), i._idx = y, i.onmousemove =
                                    ...
                                    "horizontal" == this.dataRangeOption.orient
                                        ? m += U + (u ? 5 : 0) + (u ? h.getTextWidth(e, l) : 0) + p
                                        : V += d + p;
                            !u &&
                        ...
                        _buildGradient: function () {
                                ...
                                (d = !1, this.dataRangeOption.text[0] &&
                                    (i = this._getTextShape(r, s, this.dataRangeOption.text[0]),
                                        "horizontal" == this.dataRangeOption.orient
                                            ...
                                            : (s += V + this._textGap, i.style.y += V / 2 + this._textGap, i.style.textBaseline =
                                                "bottom"),
                                        this.shapeList.push(new n(i))));
                            for (var p = e("zrender/tool/color"),
                                ...
                                g > y;
                                y++) u.push([y * c, this.dataRangeOption.color[y]]);
                            "horizontal" == this.dataRangeOption.orient
                                ? (t = {
                                    zlevel: this.getZlevelBase(),
                                    z: this.getZBase(),
                                ...
                                : (t = {
                                    ...
                                    hoverable: !1
                                }, s += m * U + this._textGap), this.shapeList.push(new a(t)), this._calculableLocation =
                                t.style, this.dataRangeOption.calculable &&
                                (this._buildFiller(), this._bulidMask(), this._bulidHandle()), this._buildIndicator(), !d &&
                                this.dataRangeOption.text[1] &&
                        ...
                        _bulidHandle: function () {
                            ...
                            "horizontal" == this.dataRangeOption.orient
                                ? "bottom" != this.dataRangeOption.y
                                    ? (e = [[m, V], [m, V + d + c], [m - c, V + d + c], [m - 1, V + d], [m - 1, V]], t =
                                        m - u / 2 - c, i = V + d + c / 2 + 2, n =
                                        { x: m - u - c, y: V + d, width: u + c, height: c }, a =
                                        [
                                            [m + U, V], [m + U, V + d + c], [m + U + c, V + d + c], [m + U + 1, V + d],
                                            [m + U + 1, V]
                                        ],
                                        r = m + U + u / 2 + c, s = i, l = { x: m + U, y: V + d, width: u + c, height: c })
                                    : (e = [[m, V + d], [m, V - c], [m - c, V - c], [m - 1, V], [m - 1, V + d]], t =
                                        m - u / 2 - c, i =
                                        V - c / 2 - 2, n = { x: m - u - c, y: V - c, width: u + c, height: c }, a =
                                        [
                                            [m + U, V + d], [m + U, V - c], [m + U + c, V - c], [m + U + 1, V], [m + U + 1, V + d]
                                        ], r =
                                        m + U + u / 2 + c, s = i, l = { x: m + U, y: V - c, width: u + c, height: c })
                                : (u += c, "right" != this.dataRangeOption.x
                                    ? (e = [[m, V], [m + U + c, V], [m + U + c, V - c], [m + U, V - 1], [m, V - 1]], t =
                                        m + U + u / 2 + c / 2, i = V - c / 2, n =
                                        { x: m + U, y: V - c, width: u + c, height: c }, a =
                                        [
                                            [m, V + d], [m + U + c, V + d], [m + U + c, V + c + d], [m + U, V + 1 + d],
                                            [m, V + d + 1]
                                        ], r = t, s = V + d + c / 2, l = { x: m + U, y: V + d, width: u + c, height: c })
                                    : (e = [[m + U, V], [m - c, V], [m - c, V - c], [m, V - 1], [m + U, V - 1]], t =
                                        m - u / 2 - c / 2, i = V - c / 2, n =
                                        { x: m - u - c, y: V - c, width: u + c, height: c }, a =
                                        [
                                            [m + U, V + d], [m - c, V + d], [m - c, V + c + d], [m, V + 1 + d],
                                            [m + U, V + d + 1]
                                        ],
                                        r = t, s = V + d + c / 2, l = { x: m - u - c, y: V + d, width: u + c, height: c })),
                                this._startShape =
                                {
                                    style: {
                                        pointList: e,
                                ...
                                this._endShape.style.width = 0, this._startShape.style.height =
                        ...
                        _getItemGroupLocation: function () {
                            ...
                            if (this.dataRangeOption.calculable) {
                                var g = Math.max(h.getTextWidth(this.dataRangeOption.max, s),
                        ...
                        _syncFillerShape: function (e) {
                            ...
                            "horizontal" == this.dataRangeOption.orient
                                ? (t = this._startShape.style.x, i =
                                    ...
                                    t - n, this._endMask.style.x = i, this._endMask.style.width =
                                    n + o - i, this._range.start =
                                    Math.ceil(100 - (t - n) / o * 100), this._range.end =
                                    Math.floor(100 - (i - n) / o * 100))
                        ...
                        _syncShape: function () {
                            this._startShape.position =
                                ...
                                this.getColor(this._gap * this._range.start + this.dataRangeOption.min), this._endShape
                                    .position =
                                [
                        ...
                        __dataRangeSelected: function (e) {
                            ...
                            this._useCustomizedSplit()
                                ...
                                : (n = (this._colorList.length - i) * this._gap + this.dataRangeOption.min, a =
                                    n - this._gap),
                        ...
                        __dispatchHoverLink: function (e) {
                            ...
                            if (this.dataRangeOption.calculable) {
                                ...
                                n = "horizontal" == this.dataRangeOption.orient
                                    ? (1 -
                                        (l.getX(e.event) - this._calculableLocation.x) / this._calculableLocation.width) *
                                    a
                                    : (1 -
                                        (l.getY(e.event) - this._calculableLocation.y) / this._calculableLocation.height) *
                                    a,
                                    t = n - .05 * a, i = n + .05 * a;
                        ...
                        _buildColorList: function (e) {
                            if (this._colorList =
                                m.getGradientColors(this.dataRangeOption.color,
                                    Math.max((e - this.dataRangeOption.color.length) / (this.dataRangeOption.color.length - 1),
                                        0) +
                        ...
                        getColorByIndex: function (e) {
                            return e >= this._colorList.length ? e = this._colorList.length - 1 : 0 > e && (e = 0), this
                                ._colorList[
                                e];
                        },
                    ...
                    [
                        "require", "./base", "zrender/shape/Rectangle", "zrender/shape/Sector", "zrender/shape/Circle", "../config",
                        "zrender/tool/util", "zrender/tool/color", "zrender/tool/event", "../component"
                    ],
                    function (e) {
                        function t(e, t, n, a, o) {
                            if (this.rcOption = {}, a.roamController && a.roamController.show) {
                                ...
                                var r = this;
                                this._drictionMouseDown = function (e) { return r.__drictionMouseDown(e) }, this._drictionMouseUp =
                                    function (e) { return r.__drictionMouseUp(e) }, this._drictionMouseMove =
                                    function (e) { return r.__drictionMouseMove(e) }, this._drictionMouseOut =
                                    function (e) { return r.__drictionMouseOut(e) }, this._scaleHandler =
                                    function (e) { return r.__scaleHandler(e) }, this.refresh(a);
                            }
                        }
                        ...
                        return t.prototype = {
                            ...
                            _buildShape: function () {
                                if (this.rcOption.show) {
                                    this._itemGroupLocation =
                                        this._getItemGroupLocation(), this._buildBackground(), this._buildItem();
                                    for (var e = 0, t = this.shapeList.length; t > e; e++) this.zr.addShape(this.shapeList[e]);
                                }
                            },
                            _buildItem:
                                function () {
                                    this.shapeList.push(this._getDirectionShape("up")),
                                        ...
                                        this.shapeList.push(this._getScaleShape("scaleUp")), this.shapeList.push(
                            ...
                            _getDirectionShape: function (e) {
                                ...
                                return o = new a(o), o._roamType = e, o.onmousedown = this._drictionMouseDown, o.onmouseup =
                                    this._drictionMouseUp, o.onmousemove = this._drictionMouseMove, o.onmouseout =
                                    this._drictionMouseOut, o;
                            },
                            ...
                            _drictionHandlerOn: function (e) {
                                ...
                                var t = this;
                                this.dircetionTimer =
                                    setInterval(function () { t._dispatchEvent(e.event, e.target._roamType) }, 100), h.stop(e.event);
                            },
                            ...
                            _dispatchEvent: function (e, t) {
                                this.messageCenter.dispatch(r.EVENT.ROAMCONTROLLER,
                                    e,
                                    { roamType: t, mapTypeControl: this.rcOption.mapTypeControl, step: this.rcOption.step },
                                    this.myChart);
                            },
                            refresh: function (e) {
                                e &&
                                    (this.option = e || this.option, this.option.roamController =
                                        this.reformOption(this.option.roamController), this.rcOption = this.option.roamController),
                                    this.clear(), this._buildShape();
                            }
                        }, s.inherits(t, i), e("../component").define("roamController", t), t;
                    }), define("echarts/layer/heatmap",
                        ["require"],
                        function () {
                            function e(e) {
                            ...
                            return e.prototype = {
                                getCanvas: function (e, t, a) {
                                    ...
                                    for (var h = l.getContext("2d"), m = e.length, V = 0; m > V; ++V) {
                                        var U = e[V],
                                            ...
                                            c = U[2],
                                            u = Math.min(1,
                                                Math.max(c * this.option.valueScale || this.option.minAlpha, this.option.minAlpha));
                                    ...
                                    for (var y = h.getImageData(0, 0, l.width, l.height), g = y.data, m = g.length / 4; m--;) {
                                        ...
                                        g[b - 3] = r[4 * f], g[b - 2] = r[4 * f + 1], g[b - 1] =
                                            r[4 * f + 2], g[b] *= this.option.opacity;
                                    }
                                ...
                                _getBrush: function () {
                                    if (!this._brushCanvas) {
                                        ...
                                        n.shadowOffsetX = t, n.shadowBlur = this.option.blurSize, n.shadowColor =
                                            "black", n.beginPath(), n.arc(-e, e, i, 0, 2 * Math.PI, !0), n.closePath(), n.fill();
                                    }
                                    ...
                                    if (!this._gradientPixels) {
                                        ...
                                        for (var i = t.getContext("2d"),
                                            ...
                                            "string" == typeof this.option.gradientColors[r]
                                                ? a.addColorStop((r + 1) / o, this.option.gradientColors[r])
                                                : a.addColorStop(this.option.gradientColors[r].offset,
                        ...
                        }), define("echarts/util/mapData/params",
                            ["require"],
                            function (e) {
                                function t(e) {
                                    if (!e.UTF8Encoding) return e;
                                    for (var t = e.features, n = 0; n < t.length; n++)
                                        for (var a = t[n], o = a.geometry.coordinates, r = a.geometry.encodeOffsets, s = 0;
                                            s < o.length;
                                            s++) {
                                            var l = o[s];
                                ...
                                function i(e, t) {
                                    for (var i = [], n = t[0], a = t[1], o = 0; o < e.length; o += 2) {
                                        ...
                                        r = r >> 1 ^ -(1 & r), s = s >> 1 ^ -(1 & s), r += n, s += a, n = r, a =
                                            s, i.push([r / 1024, s / 1024]);
                                    }
                                    return i;
                                }
                                ...
                                var n = {
                                    ...
                                    "南海诸岛": {
                                        ...
                                        getPath: function (e, t) {
                                            for (var i = [
                                                [
                                                    [0, 3.5], [7, 11.2], [15, 11.9], [30, 7], [42, .7], [52, .7], [56, 7.7],
                                                    [59, .7],
                                                    [64, .7], [64, 0], [5, 0], [0, 3.5]
                                                ...
                                                [
                                                    [0, 3.5], [0, 93.1], [64, 93.1], [64, 0], [63, 0], [63, 92.4], [1, 92.4],
                                                    [1, 3.5],
                                                    [0, 3.5]
                                                ]
                                            ],
                                    ...
                                    "新疆": { getGeoJson: function (i) { e(["./geoJson/xin_jiang_geo"], function (e) { i(t(e)) }) } },
                                    "西藏": { getGeoJson: function (i) { e(["./geoJson/xi_zang_geo"], function (e) { i(t(e)) }) } },
                                    "内蒙古": { getGeoJson: function (i) { e(["./geoJson/nei_meng_gu_geo"], function (e) { i(t(e)) }) } },
                                    "青海": { getGeoJson: function (i) { e(["./geoJson/qing_hai_geo"], function (e) { i(t(e)) }) } },
                                    "四川": { getGeoJson: function (i) { e(["./geoJson/si_chuan_geo"], function (e) { i(t(e)) }) } },
                                    "黑龙江": { getGeoJson: function (i) { e(["./geoJson/hei_long_jiang_geo"], function (e) { i(t(e)) }) } },
                                    "甘肃": { getGeoJson: function (i) { e(["./geoJson/gan_su_geo"], function (e) { i(t(e)) }) } },
                                    "云南": { getGeoJson: function (i) { e(["./geoJson/yun_nan_geo"], function (e) { i(t(e)) }) } },
                                    "广西": { getGeoJson: function (i) { e(["./geoJson/guang_xi_geo"], function (e) { i(t(e)) }) } },
                                    "湖南": { getGeoJson: function (i) { e(["./geoJson/hu_nan_geo"], function (e) { i(t(e)) }) } },
                                    "陕西": { getGeoJson: function (i) { e(["./geoJson/shan_xi_1_geo"], function (e) { i(t(e)) }) } },
                                    "广东": { getGeoJson: function (i) { e(["./geoJson/guang_dong_geo"], function (e) { i(t(e)) }) } },
                                    "吉林": { getGeoJson: function (i) { e(["./geoJson/ji_lin_geo"], function (e) { i(t(e)) }) } },
                                    "河北": { getGeoJson: function (i) { e(["./geoJson/he_bei_geo"], function (e) { i(t(e)) }) } },
                                    "湖北": { getGeoJson: function (i) { e(["./geoJson/hu_bei_geo"], function (e) { i(t(e)) }) } },
                                    "贵州": { getGeoJson: function (i) { e(["./geoJson/gui_zhou_geo"], function (e) { i(t(e)) }) } },
                                    "山东": { getGeoJson: function (i) { e(["./geoJson/shan_dong_geo"], function (e) { i(t(e)) }) } },
                                    "江西": { getGeoJson: function (i) { e(["./geoJson/jiang_xi_geo"], function (e) { i(t(e)) }) } },
                                    "河南": { getGeoJson: function (i) { e(["./geoJson/he_nan_geo"], function (e) { i(t(e)) }) } },
                                    "辽宁": { getGeoJson: function (i) { e(["./geoJson/liao_ning_geo"], function (e) { i(t(e)) }) } },
                                    "山西": { getGeoJson: function (i) { e(["./geoJson/shan_xi_2_geo"], function (e) { i(t(e)) }) } },
                                    "安徽": { getGeoJson: function (i) { e(["./geoJson/an_hui_geo"], function (e) { i(t(e)) }) } },
                                    "福建": { getGeoJson: function (i) { e(["./geoJson/fu_jian_geo"], function (e) { i(t(e)) }) } },
                                    "浙江": { getGeoJson: function (i) { e(["./geoJson/zhe_jiang_geo"], function (e) { i(t(e)) }) } },
                                    "江苏": { getGeoJson: function (i) { e(["./geoJson/jiang_su_geo"], function (e) { i(t(e)) }) } },
                                    "重庆": { getGeoJson: function (i) { e(["./geoJson/chong_qing_geo"], function (e) { i(t(e)) }) } },
                                    "宁夏": { getGeoJson: function (i) { e(["./geoJson/ning_xia_geo"], function (e) { i(t(e)) }) } },
                                    "海南": { getGeoJson: function (i) { e(["./geoJson/hai_nan_geo"], function (e) { i(t(e)) }) } },
                                    "台湾": { getGeoJson: function (i) { e(["./geoJson/tai_wan_geo"], function (e) { i(t(e)) }) } },
                                    "北京": { getGeoJson: function (i) { e(["./geoJson/bei_jing_geo"], function (e) { i(t(e)) }) } },
                                    "天津": { getGeoJson: function (i) { e(["./geoJson/tian_jin_geo"], function (e) { i(t(e)) }) } },
                                    "上海": { getGeoJson: function (i) { e(["./geoJson/shang_hai_geo"], function (e) { i(t(e)) }) } },
                                    "香港": { getGeoJson: function (i) { e(["./geoJson/xiang_gang_geo"], function (e) { i(t(e)) }) } },
                                    "澳门": { getGeoJson: function (i) { e(["./geoJson/ao_men_geo"], function (e) { i(t(e)) }) } }
                                };
                                ...
                                function () {
                                    ...
                                    [],
                                    function () { return { Russia: [100, 60], "United States of America": [-99, 38] } }), define(
                                        ...
                                        function (e) {
                                            ...
                                            function n(e, t) {
                                                function i(e) {
                                                    ...
                                                    if (m[t]) {
                                                        var o = m[t](e, n);
                                                        o &&
                                                            (o.scale = n, o.properties = { name: e.getAttribute("name") || "" }, o.id =
                                                                e.id, s(o, e), a.push(o));
                                                    }
                                            ...
                                            function s(e, t) {
                                                ...
                                                i && "none" != i
                                                    ? (e.color = i, n ? (e.brushType = "both", e.strokeColor = n) : e.brushType = "fill")
                                                    : n && "none" != n && (e.strokeColor = n, e.brushType = "stroke"), a &&
                                                    "none" != a &&
                                                    (e.lineWidth = parseFloat(a)), o && "none" != o && (e.opacity = parseFloat(o));
                                            }
                                                    ...
                                                    polygon: function (e, t) {
                                                        ...
                                                        if (i) {
                                                            ...
                                                            for (var o = 0; o < i.length; o++) {
                                                                var r = i[o];
                                                                n[0] = Math.min(r[0], n[0]), n[1] = Math.min(r[1], n[1]), a[0] =
                                                                    Math.max(r[0], a[0]), a[1] =
                                                                    Math.max(r[1], a[1]);
                                                            }
                                                            return {
                                                                shapeType: "polygon",
                                            ...
                                            function () {
                                                ...
                                                function i(e, i, n) {
                                                    function a(e, t) {
                                                        c = e.type, u = e.coordinates, o._bbox = { xmin: 360, xmax: -360, ymin: 180, ymax: -180 }, y =
                                                            o[c](u), m.push({
                                                                path: y,
                                                                cp: o.makePoint(t.properties.cp
                                                                    ? t.properties.cp
                                                                    : [(o._bbox.xmin + o._bbox.xmax) / 2, (o._bbox.ymin + o._bbox.ymax) / 2]),
                                                    ...
                                                    n = n || {}, o.scale = null, o.offset = null, e.srcSize || t(e, n), i.offset =
                                                        { x: e.srcSize.left, y: e.srcSize.top, left: i.OffsetLeft || 0, top: i.OffsetTop || 0 }, o.scale =
                                                        i.scale, o.offset = i.offset;
                                                ...
                                                function n(e, t) {
                                                    var i, n;
                                                    return t instanceof Array ? (i = 1 * t[0], n = 1 * t[1]) : (i = 1 * t.x, n = 1 * t.y), i =
                                                        i / e.scale.x + e.offset.x - 168.5, i = i > 180 ? i - 360 : i, n =
                                                        90 - (n / e.scale.y + e.offset.y), [i, n];
                                                }

                                                function a(e, t) {
                                                    return o.offset = e.offset, o.scale =
                                                        e.scale, o.makePoint(t instanceof Array ? [1 * t[0], 1 * t[1]] : [1 * t.x, 1 * t.y]);
                                                }
                                                ...
                                                var o = {
                                                    ...
                                                    makePoint: function (e) {
                                                        ...
                                                        t._bbox.xmin > e[0] && (t._bbox.xmin = e[0]), t._bbox.xmax < e[0] && (t._bbox.xmax = e[0]),
                                                            t._bbox.ymin > e[1] && (t._bbox.ymin = e[1]), t._bbox.ymax < e[1] && (t._bbox.ymax = e[1]);
                                                    ...
                                                    r = {
                                                        ...
                                                        makePoint: function (e) {
                                                            ...
                                                            t.xmin > n && (t.xmin = n), t.xmax < n && (t.xmax = n), t.ymin > a && (t.ymin = a),
                                                                t.ymax < a &&
                                                                (t.ymax = a);
                                                        },
    ...
    define("echarts/util/mapData/geoJson/guang_xi_geo",
        ...
        function () {
            ...
            function () {
                    ...
                    type: "FeatureCollection", features: [
                        {
                            ...
                            type: "Feature", id: "469005", properties:
                                { name: "文昌市", cp: [110.8905, 19.7823], childNum: 1 }, geometry: {
                                    type: "Polygon", coordinates:
                                        ["@@hĲ¤Ī¯LQDaFßL[VQìwGF~Z^Ab[¹ZYöpFº lN®D´INQQk]U[GSU©S_­c}aoSiA£cÅ¡©EiQeU­qWoESKSSOmwćõWkàmJMAAMMCWHGoM]gA[FGZLZCTURFNBncVOXCdGB@TSbk\\gDOKMNKWQHIvXDJ\\VDTXPERHJMFNj@OwX@LOTGzL^GHN^@RPHPE^KTDhhtBjZL[Pg@MNGLEdHV[HbRb@JHEV_NKLBRTPZhERHJcH^HDRlZJOPGdDJPOpXTETaV[GOZXTARQTRLBLWDa^QAF`ENUPBP

                                            \\Eji
                                                `yºEvåà"], encodeOffsets: [[113115, 20665]] } }, { type: "Feature", id: "469033", properties: { name: "乐东黎族自治县", cp: [109.0283, 18.6301], childNum: 1 }, geometry: { type: "Polygon", coordinates: ["@@ªVLP`
                    @PEdNRAHOPEAKHEVL`GZBJfvdTAXNNTZJFPrHHNpKTD\\ILHbEVd^JOHLh@NNBnHP`
                        \\xH@NBRLJTl
                         Nv_ ^ CTLd@bNDVFbxdFV
                         UPBTKOGEOUO@OEBXQP
                [H_EI\\EbeYa@UO_J
                         MEJ_IEDKJUGMDcNUd_FMTEJSGoZ
            ]EIYGO[YW  gEQ];;;
                a; @
                WHEDQKUSDUGAbYBUpSCYNiWqOSQEoF[UcQISWWN ;;;
                MSDe_cLQ_UBiKQOOASQAWgS ­;;;
                ā];;;
                Za ;;;
                SPÝZ];;;
                XMXS ;;;
                [ ^ oVËNgNKlE;
                RôEø;
                "], encodeOffsets: [[111263, 19164]] } }, { type: ";
                Feature;
                ", id: ";
                4602;
                ", properties: { name: ";
                三亚市;
                ", cp: [109.3716, 18.3698], childNum: 1 }, geometry: { type: ";
                Polygon;
                ", coordinates: ["; @@®
                ĂhTBXTRPBRPjLVAR`dKf`;
                TC ;;;
                NXMTXRJVdE;
                \;
                \;
                FpTRrPjXZMTDVoZABaVHTCLVCRGF; @
                X ^ bFR ;;;
                hZXP;
                \;
                \;
                ...
                DQ ^
                    QNWFSHEbF
                        `OXNbOVNKTEPDTLTCCVTREfvfEHNbRAENH^RJXCFHNFRpVGHWISDOTMVCZeGamaLoLÛD¹¹ėgsia{OųETtlÉwr}jR±E{L}j]HąKÃT[P"], encodeOffsets: [[111547, 18737]] } }, { type: "Feature", id: "469036", properties: { name: "琼中黎族苗族自治县", cp: [109.8413, 19.0736], childNum: 1 }, geometry: { type: "Polygon", coordinates: ["@@bRFnHNbHgN@NPEnbXP@bND`;
                NT;
                \;
                \; @
        \;
                \;
                QZb; @
                `@J]V@XhDpWnCJGHGXO@CR§FANHVKLF\\MPVR`;
                CvVfQtDPKpGHG; @
                S`WJP~^dSTHWX\\RHTFACQTIAUPOU@MG__IaYSFQKNSbORHXCZeTFJgB`;
                YBMNMFi;
                ~IVDV[tGJWXGDQRGF];;;
                JrALgESLSAYDGIaFeXQLS;
                \;
                \;
                MKSLSQYJY;
            };
eKO[EHiGSaK[Yw[bmdURgEK ^ _kcSGEOHKIAS];
aFSU; @
Y];;;
IWFUTYlkP_CUOUEkmYbSQK; @
EMWUuAU;
\;
\;
M; @
EpK ^ _ZMDQ ^ OXwC_ZODBrERURGVVZ;
\;
\;
DTXcFWNIAWJWAYUUFYEWLQQaCIZeDM
    `cLKRGpanJZQd"], encodeOffsets: [[112153, 19488]] } }, { type: "Feature", id: "469007", properties: { name: "东方市", cp: [108.8498, 19.0414], childNum: 1 }, geometry: { type: "Polygon", coordinates: ["@@ºxJYZQIYXLl@dR\\WZEn]bA\\S~F`;
KXaDeTiNO ^ EEKWEDQXITBXaWaDQMUJOIaTWf; @
NJV; @
dSxGZ ;;;
Fu_ ;;; @
WMKAU }
...
GK ;;;
P];;;
IUcaFKG[JSCoLGMqGEOYIMSWMSBucIeYA_HUKGFBLOFGPQBcMOF_; @
KO ©;;;
UAtERadwZQ;
\;
\; @
...
KĮV ;;;
LJ;
"], encodeOffsets: [[111208, 19833]] } }, { type: ";
Feature;
", id: ";
4601;
", properties: { name: ";
海口市;
", cp: [110.3893, 19.8516], childNum: 1 }, geometry: { type: ";
Polygon;
", coordinates: ["; @@
ńZƂtĢ ¬;;;
æßFuz ¹;;;
...
\;
\;
HbUFSWSPoIOcCOHIPkYCQ];;;
GdGGIFQYgSOAQLK`MFUIGa@aQ\\GGUFcHKNMh@\\OYKAigsCgLSF]GOQO]@GM]HyKSHKPW@Pxi@EMINYREXWRQ@MQcFGWIAwXGRH\\yDI`;
KJIdOCGRNPNtd;
\;
\;
UTMbQYi; @]
JeYOWaL[EcICMUJqWGDNZEXGJWFEXNbZRELFV];
XQbAZFrYVUBCLNFCHmJaMIDDHXHEhQNXZ_TARFHVB; @
DTQIRR; @
YHAJVnAbKFUEMLd;
\;
\;
c ^ ÍÞ;
"], encodeOffsets: [[112711, 20572]] } }, { type: ";
Feature;
", id: ";
469006;
", properties: { name: ";
万宁市;
", cp: [110.3137, 18.8388], childNum: 1 }, geometry: { type: ";
Polygon;
", coordinates: ["; @@^
    J; @
    ZTVbET ^ JBGLFPTHld];;;
`FLQhcVanx\\\\ZbLHTGj\\FLP~fIZRZPVTQFSVAFJE^NDLEE[~LjsxVTG\\NZZNGlLRRGLJTV@hPZANN^@T\\NEPPbDZXO`;
d ^ HSvcJDIV;
\;
\;
XZAJUFCLNP; @
...
I;
{
    ...
    \;
    \;
    F`"], encodeOffsets: [[112657, 19182]] } }, {
            type: "Feature", id: "469027", properties: { name: "澄迈县", cp: [109.9937, 19.7314], childNum: 1 }, geometry: {
                type: "Polygon", coordinates: ["@@T\\GJCXJH@fJDDPNCNJENN^NLHBNSx@DDYbBLLDRbjZTj@`;
    XXTlG ^ Xr; @
    PJLW;
    \;
    \;
    ...
    JQSR; @
    CUAEGBQ
        `SWYRMFgWGCGJCbNnIDGMEDKVAZUEqBYRa^WEUFKYQMaFWXEHIFWMYHCrXVIIiaK@aMCUYNSIISTwXALKH@XWXIEIJQCG[IEQDE_XSBaa[AIPW@]RS[FWS[CD]PEBYNGFSaSyJG]@ugEUDQlGHiBKHUIoNSKqHFaPMICK]UUHIPDJMuCA[SCPIDIOILGAEmU[POPBVSJDREBGS[QXWSGcT}]IO_X@TGHoHOLCX\\ELT@LYTDaFENF\\lj"],
                encodeOffsets: [[112385, 19987]]
            }
        }, { type: "Feature", id: "469030", properties: { name: "白沙黎族自治县", cp: [109.3703, 19.211], childNum: 1 }, geometry: { type: "Polygon", coordinates: ["@@D\\RV]dTXELnHr]^@LETBBRTHPi^[@U`;
    QTHDJ`MGSogDIPKdJ`;
    WVNHCXHl_DJR; @
    AH`FBVPUJLHKNTJOFFZON[ZEHFCJlMJ_Cn`;
    ...
    f;
    {
        ...
        MckBIw[AOSKKAMPSDSLOA ;;;
        V_; @@
        `KJRbKRDfMdHZERgAWVsDMTUHqOUr@VQXTT@TfgL^NH\\@heTCZaESNObHPHeZF\\X^ElM^F^"], encodeOffsets: [[111665, 19890]] } }, { type: "Feature", id: "469002", properties: { name: "琼海市", cp: [110.4208, 19.224], childNum: 1 }, geometry: { type: "Polygon", coordinates: ["@@TP\\pATHTGlZDJGAQjE\\Rb@jVBDCN`;
        JZ[NCNHNXbULPrP;
        \;
        \;
        KNbMTLjJJRFP
            `pNLZz^FLRHjVPZ@hxVKbHBHMNNJFRlLzGPnNHhIrHHADcPWdUAmEMVQDSKYHY\\EhBN^HpXGNDBNNBnIßÅ_g{³So]Ã£@ORO@KMEDIVYB[WJUICudGTc]P_YWaCOOMFS[]@MMYBgOU@ISHKQQkKMHYY[MSHwUit}KF\\KFMCF]EIUBETSROUKTLT[NKTWREfJbCHBZKTFTKh"], encodeOffsets: [[112763, 19595]] } }, { type: "Feature", id: "469031", properties: { name: "昌江黎族自治县", cp: [109.0407, 19.2137], childNum: 1 }, geometry: { type: "Polygon", coordinates: ["@@`;
        ZĤd ;;; `òü BSPGP@VSbQ`@]
        HC;
        ~T ^ SE];;;
        N];;;
        ...
        e; @
        SSSRW; @
        UVqrPVGNStCXUhBFQGYNcCeLQQaLI; @
        _`@EUwcEaCUaMc@SK]Du`;;;
        MSkKI ;;;
        ~BVNL; @
        X`EvYwHcTU@MIe@SXJbIPNVCRXbWbSAWJCRXFFL]FMPSjCfWb_L}E[TaBm^YF[XcQk@WKZJYRIZw¹ "], encodeOffsets: [[111208, 19833]] } }, { type: "Feature", id: "469028", properties: { name: "临高县", cp: [109.6957, 19.8063], childNum: 1 }, geometry: { type: "Polygon", coordinates: ["@@jD`;
        hNd;
        \;
        \ ^ dZädĒH ´;;;
        Op; @
        ...
        OAGIMN[[W_NCNMKU;@
        NUMSNCTSP; @
        `O@WSCCI@GXQSkXKX[IK@OWqH]SkWW@_SiiYQaKCAKZaCCw@MTGAMKM]FMMIMDSM_HGHRPKCBGSJJIYH[QOJCHMBDGQJECMTDQKFGTCEGTF`;
        NFEDMFaGSNwIiTGhYJD;
        \;
        \;
        KZODC ^ ; @
        FTKND
            `XBHKJNKFBNhG^FJMPcHEZF\\QPRjQTAdgNOPgQaRSê"], encodeOffsets: [[112122, 20431]] } }, { type: "Feature", id: "469034", properties: { name: "陵水黎族自治县", cp: [109.9924, 18.5415], childNum: 1 }, geometry: { type: "Polygon", coordinates: ["@@R]NC`;
        YL];;;
        FoN; @
        V[vBXVFNL;@
        TRZalnVFVP
            `DlOZkVSXEE_F[EUFeH[NKTgfCbMVU^@P]ZObZP@\\QhATUfAtUasñiāEoI]eYǯ@aKmaeWuCºKÜKpnbHbYfUDSNCPJTRAHJTDJSfDNLHXC`
            `VBNGTYCQDIXMDSP@xLNEFRNXBIpVNLXah@RgF@`;
        qOML; @
        LJNSPLbaHAh; @
        Jdj;
        "], encodeOffsets: [[112409, 19261]] } }, { type: ";
        Feature;
        ", id: ";
        469026;
        ", properties: { name: ";
        屯昌县;
        ", cp: [110.0377, 19.362], childNum: 1 }, geometry: { type: ";
        Polygon;
        ", coordinates: ["; @@
        \;
        \;
        ...
        \;
        \;
        vDINOCGJVVL ^ JDONEbrGTLpMVJLGjAHGRkVChF; @
        vH ^ zIbTETMHAZOFC ^ \;
        \;
        DXT;
        \;
        ...
        YPICMeM; @
        sC[_A];
        VQEwyHSMuNcAUlQJMVGMS; @
        mVBZPFO;
        \;
        \;
        CS ;;;
        FQK[LqDMACiUa; @
        [QiFBRIHYCHkGSBS[oSOqB ;;;
            IE ^ QHCRWHIXsHU;
            \;
            \;
            UC;
    ...
    ERZTJb``;
    NHV; @
    "], encodeOffsets: [[112513, 19852]] } }, { type: ";
    Feature;
    ", id: ";
    469025;
    ", properties: { name: ";
    定安县;
    ", cp: [110.3384, 19.4698], childNum: 1 }, geometry: { type: ";
    Polygon;
    ", coordinates: ["; @@
    JjDNdJ;
    \;
    \;
    FbKPXfZ ^ Ij; @
    RZNaVSc[MsMOHQPDJcLIJ_zCG[HQxWJBHXdENRR;@
    XQFWZQQGOFSWUCI[WCJuRGLXNMPLhCl[Ta;@
    SqGgJMGOmyHkKEQMINMAGaGULgwY;
    @
    UOGiKQ];;;
    EYyMK ;;;
    oO_QEIIKiNSMa[LqOKOaVMWMGMDY;
    \;
    \;
    _IKrL;
    \;
    ...
    ERT ;;;
    [DEPYOUA;@
    nNTUHINkRBVMdNvGTxzRF ^ U`BD\\@tfNDNOJ@Z{TeTJZ@VUcB[OBOeeQT@^OXBJb\\AbWTF`;
    RCJFH;
    \;
    \;
    RDJIJFXW; @
    WLGBKxWTSJJMTVZND; @
    bbL;
    "], encodeOffsets: [[112903, 20139]] } }, { type: ";
    Feature;
    ", id: ";
    469035;
    ", properties: { name: ";
    保亭黎族苗族自治县;
    ", cp: [109.6284, 18.6108], childNum: 1 }, geometry: { type: ";
    Polygon;
    ", coordinates: ["; @@
    FJp; @
    fxpQ;
    ...
    \;
    \;
    GNPNBM`HLMrXLXj\\PEHnI@WUCEM\\GTc\\GZYHTPBHRCPTdH\\K\\@HXiBJILJJAVNTOZJNtFPC`;
    YxDPWci; @
    IBgbGKaTOIM; @
    KNKrP; @
    _hE; @
    QbgKWUMJoWAQMFEKM; @
    wTONCJWRCZDHSAM_UD_GWMKeCITSCGIQBGXUHQoMEEGWDQIG];;;
    FMQBMaFGueFeSQDUSDSKOCSFML ;;;
    UaPWM_PaEGFETMX];;;
    RCRR; @
    HXKN; @
    JNnXXE ;;;
    ...
    \;
    GN;
    "], encodeOffsets: [[112031, 19071]] } }, { type: ";
    Feature;
    ", id: ";
    469001;
    ", properties: { name: ";
    五指山市;
    ", cp: [109.5282, 18.8299], childNum: 1 }, geometry: { type: ";
    Polygon;
    ", coordinates: ["; @@
    TCNOLBTLBPx;
    \;
    ...
    \;
    \; @
    RcIYbmHoLQdKN_fCJYbDRRXKZFVEZVXBXIJBXMdESW[CUYHUVQFQAqsEIMPYMSBUIIJKAIj ;;;
        GW[;@
        [L ;;;
            GScDOGQOAGSYZ[HSd[HFNVD;@
            XmJFG[OWiWKNqGKN_MAMO[HoM[BoRewo;@
            Y ^ HpITSFENc`MVCdHNIVCLJFI`;
    NFI ;;;
    P`@VZbaf[FFJG`;
    O;
    \;
    ...
    WRFA; @
    PVPFPPH;
    "], encodeOffsets: [[111973, 19401]] } }], UTF8Encoding: !0;;;
}
}),
                ...
                function () {
                    return {
                        ...
                        features: [
                            ...
                            @EFGLEBa @ACoCCDDD @LGHD @DJFBBJED @BGAEGGFKIGDBDLBAD @FHBEF @RFDMLE @SGANFFJBANPH @@E @
                    FJjRIACDMDOEKLFD @
                    DbDAJI @AP @BGHFBCBGDCC @DCA @CECGH @FKCEHFJGBFDIHACEDNJDCVFBDCRKRLDLITB @
                    CjNJI ^ DBCfNVDHDFKHAFGDIICDWBIF@@CFAjFJNJBBHD @CJ @AEFJ @@DH @BFBCPDBMFEQGDIFCNDHIP @
                    HDABFACBJFHEBSZC @DP @@JDBƤ
                    ~"], encodeOffsets: [[124854, 31907]] } }, { type: "Feature", id: "310120
                    ", properties: { name: "奉贤区", cp: [121.5747, 30.8475], childNum: 1 }, geometry: { type: "
                    Polygon
                    ", coordinates: ["@@~T
                    ~JjZdDbLXDLCB_J@@FHFZJJIAGH @HGR @BENBLID @@LFCDF
                                \\FpDBDb@FAHKFE
                                @dEDDdC
                                \\GreNMACVMLBTMCCFCEGFAA@DAFDLMHA @OD @BMEWDOC @AS @KGAI_DcKw
                                 ÕísƝ  åĆctKbMBQ@EGEBEJ @@MBKL @BJB @FIBGKE @ABG @@FMFCPL @AjCD @ZOFCJIDICIlKJHNGJALH @@
                    FPDCTJDGDBNCn
                    "], encodeOffsets: [[124274, 31722]] } }, { type: "Feature", id: "310115
                    ", properties: { name: "浦东新区", cp: [121.6928, 31.2561], childNum: 1 }, geometry: { type: "
                    Polygon", coordinates: ["@@EN @JJLNHjLJNR ^ GRYVBNZJRBV@PDvbLNDN @LGNER @nCNQNuT_TIVFV
                                \\Z\\XnDrI | [Ʉś ² ÏJUHOƣ
                        }CA@IO @@CYDATGFIEDAEBBAGCO @GJMCEDCJRHEFANOCADAEG @@CI @FE @BDIC @AGIAIMiEEB @DE @
AJCXJDCJEHGBELGCUCeMAD
                            ]CIJiM@DSAKJKCLQDQACUECDMIFCBDJGECHAEIWCK @GLMCCGEACNKCEJG @MMBMC @@CIJUINT @JAJSTEPZZCP
                        ...
                        features: [
                            {
                                type: "Feature", id: "7100", properties:
                                    { name: "台湾", cp: [121.0295, 23.6082], childNum: 1 }, geometry:
                                {
                                    type: "Polygon", coordinates: ["@@\\s@pS}aekgKSuSsMß`¡CqZ·be@Q^o@gieMp]}}Ľc_Kk
                    {  ù   A ¡ r [uom@Ñ
                         ĥJiq © mŉq ¯ Bq
            ]ÙYgSåk_gwU ­ isT  E
                       ĕiqiUEku  e_  OSsZ  aWKo ¡  ­ q  yc  Y £ w
                };;;
ĩ ;;;
ĕS §;;;
Z ©;;;
...
[cíȈE ;;;
    ...
    \;
    \;;;
    "], encodeOffsets: [[124853, 25650]] } }], UTF8Encoding: !0 } }), define(";
    ...
    ", properties: { name: ";
    蓟县;
    ", cp: [117.4672, 40.004], childNum: 1 }, geometry: { type: ";
    Polygon;
    ", coordinates: [";@@
    EUDAEI; @
    WNMNCBFAHFFNACDJDPBD; @@
    GD; @
    DIFFHEFGDBDEQOFG; @
    EI_KG; @
    OcJQM];;;
...
[LaCIICBWK ;;;
    ...
    WBQHCDFD; @
    HSLEJI; @
    IHWECFGAAEKCGDBFCBSBIDCKKHEADMJMFABKOKEQAA; @
    IEEG; @
    GIQAEK; @
    OZEESMOL ;;;
lu; @
...
A; @@
AAAKAE; @
GFGDECEFEECBKIKDELDFEDYH; @
EIACDCHKBEB; @
BAAC; @
ADBHABKJIAIJICEDGDCD;
@@
A; @
A; @
DHCHJHDFEFGBKRKBGIK; @
GIMHSBCH_BOJECCJCFKKMD; @
DNJEDEGC; @
OJCJHRUL; @
HRJ; @
H[DCNKDZHCTFDHCFFKR`TANVDFZRDLFARB@HPAPG`;
    ILAR;@
    TERNDFNHDLCLDDCXDYbHF; @
    FEB; @
    LDDVE; @
    JPNfXPINCVDJJD; @
    NJPAJHLXHDNANHhB; @
    DPNLRMTBFRBHHr; @
    `NBFEBOCCBIAQJDHCHLHFA@HSDCRLFTB@HEFLNF@PELBDJALFLTC@EPFLLP@tUHQJDfIHGTB^JTCPDLKAIBATFPADIEGECEMJ@JIAIHGECFEAGDI\\SPOXAFCL@BQTQBBTMZECYGAHA@GJAE@HCAEME@IECFKJADDBABLTHHG@ILEAMNDJCDHEBF@@JNFJELDFKTOT@JETBFFHBHEHKI@@IJEJ@XKEOUMS@AF@CEB"], encodeOffsets: [[120575, 41009]] } }, { type: "Feature", id: "120114", properties: { name: "武清区", cp: [117.0621, 39.4121], childNum: 1 }, geometry: { type: "Polygon", coordinates: ["@@FWôµ@IFCLIB@EHNBp]AGEAKAEDMGZKFGBGME@ILGP@HEFB@BXMEAHUGC@IHCLOD@X[NWHWPKAEF[@EKIOL@EKGBNMJ@EIEHKBIC@BAKMIACCFQZCF]DB@ERAKADIHGEIBCGIIECFaGLZO@EFCNGAGDGAKL@BMG@IE@ADSDEH[JGC@CGA@BMDeK@EIACFE@@GG@FIAMM@CCGC@EM@ADE@CFMAAGHBDKIEAJG@DOGCDEKAGIS@KFCHKAEHIE]BeKNO[IFIOELC@A]GMBKVYCDDgGAICARc@MW@AQE@DGI@@AQ@@BKBAIQQYEFW@CEADIGGBCEIiMEMF_LGEKMBBDWEBGRC@E_CHYGCH_IAED@FFBQh@FGJaJ}AHRAREF@bE\\C@CT`;
FHC; @
\;
\;
BBF; @
...
DF; @@
FGDWE; @
FFSIEMKQDYCCHKb ^ JADOCIDGNDBdBCFJB;
@
EC;
\;
\;
...
HHD; @
LFBCFF; @
BERDHNhZQHMBGHOACCEBWEGD; @
PSJKCGEUD; @
CINLFGHE; @
AJK; @
HDABBHTB; @
F`DBFLBBHEDARCFG@ABJBAPVFE^FBGLGCFG_BMLEXGAAFE@@JNRVJHFALFBEHQJCTbNDHCF@PlFLJSXCHFHfVBTNJ\\BPJXC^FAVNFCHFB@FFH@JF@\\ABCFD\\BDMCAAJKQBGAILOEGHILECQLWFENJHADC@QxNHFJNLDFA@CBA@DUÂmR@FBL@BD"], encodeOffsets: [[119959, 40574]] } }, { type: "Feature", id: "120115", properties: { name: "宝坻区", cp: [117.4274, 39.5913], childNum: 1 }, geometry: { type: "Polygon", coordinates: ["@@TZbB@JHD@DODCLM@AP@LL@BNH@ETFN@`;
E; @
DNG; @
CHLBCJA; @
AICFKDDBKA; @
...
DA; @
CCCBBEGA[GEDBBoNAAH];
MKiIAWKQoIIPMFQAEEDMH; @
FMSUYIeF; @
EK; @
BIOEKJEBICFKaKP ;;;
FAFSE; @
LWCCFMHDDEKESBOGBKIEIODLG; @
CCDEQCEDWEMDIEIB; @
EHGEEDAEAa; @@
HqDEJGF[AECCFa;@
WCEIKAAEQB; @
...
AEAGFO; @
KH; @
JNFAHEHYLNHFCLBFBBHo ^ MAFGA; @
KJED; @
Jó ¶;;;
EX;
"], encodeOffsets: [[119959, 40574]] } }, { type: ";
Feature;
", id: ";
120223;
", properties: { name: ";
静海县;
", cp: [116.9824, 38.8312], childNum: 1 }, geometry: { type: ";
Polygon;
", coordinates: ["; @@
NGFMDATCNDR; @
CCbINEHNJA; @
...
[IGCOCESE;@
GMA_OcCGDu
    `a@VZzKDkJBLNXGDqKEWE@cFEFA@ISIi@@KMABJGBcMuFEzGVH\\ATSEUBeALCEMG@CEBUHUCGXaBPtUBBFIBFTDFF@DDKBFNGBJPHXDDMDCLJ^mBIHIL@LR\\@LCR[@@z@NFD@LLBNb@RHDBNTPT\\F@BJF@BXCFBHHBDLFB@HODADE@@JHVXCPDHCFTLBBFNCDCCCU@@GAABEHHZHBCAEdEjFDD@GfD@DXFCHF@ERFDLBH@"], encodeOffsets: [[119688, 40010]] } }, { type: "Feature", id: "120221", properties: { name: "宁河县", cp: [117.6801, 39.3853], childNum: 1 }, geometry: { type: "Polygon", coordinates: ["@@BFLBFJXDb@DEFD\\BHEFIrC@Gb@FBCBFFGH@FJAJFNCXFFCRDCFDDH@CKJPJFALPHTALFCFGCENDDKXF@ETEBObLELJDFALIPFAJL@@FfEZJTVENG@CNFFRBNEJOpJLRBXjJNLG^BBpMAAFC\\HHBAFDADDB@@CN@FFAHFDCHLHFBJGFCFUNKJJTD\\XUXF\\^F@DDDQXXBRLRCBDFEVCDLVDpUl@LEDJHAPRFGL@CETGPBTCDDVI@CFF@GFDCCVGLKEK[Y@MECISG@BKNSCGCKWEAaEBEKNGFSECO@GGM@GYI@DÅCMLHPTF@DJHAVVNKEGDETJ^[TJNNd@NOAMFYJ@@GFANDPEJB^aOadSTQSI@MHBDIEOKCG@EEFCKCqXO@@DMFENCDDHCCGJ]AKFoDaGGHYFDHKJiCMFGC@EQ@AEHGAC@IEAATKOHGIC@IXIFEoGE[JCFCDHNmRADFZMF[EEBMO{GU@AOW@@]ZeHBDEHBKEfQkuIWBs@EC@d[@[^EDMTKCEEcI@cDAB@FCBCACmOCG{PYHeBgPwPFDDALFFFCHQGSD@BHFAR[TaFYXMASUiGFL@DQNCJI@@D@PLDN`;
ETEFIGMCGBCE ;;;
~CAIFDPEHGEQPHJADFJGHCJLB;
"], encodeOffsets: [[120145, 40295]] } }, { type: ";
Feature;
", id: ";
120109;
", properties: { name: ";
大港区;
", cp: [117.3875, 38.757], childNum: 1 }, geometry: { type: ";
Polygon;
", coordinates: ["; @@
JFFL °;;;
_`ONJKDDFIFZN xlb~yFVNRrdJGzDPVFBCTNND\\UR@E`;
F; @@
Ip; @
IWGUoawOEE; @
ÏDgK;
{
    İEEMFëC ;;;
    b; @
    KwOCDHHKBDJCDEEEAGHOABFABMCgDLSQ; @
    CFEB ;;;
    MgYIDQINE; @
    AUSwSAdYEHQMEyK[KI;@
    GRMLE; @@
    ...
    HGDICCPlVANTC ¤;;;
    vgZlfRChjLJ;
    "], encodeOffsets: [[120065, 39771]] } }, { type: ";
    Feature;
    ", id: ";
    120107;
    ", properties: { name: ";
    塘沽区;
    ", cp: [117.6801, 38.9987], childNum: 1 }, geometry: { type: ";
    Polygon;
    ", coordinates: ["; @@|
        ODHnPBDADEDA; @
        CB; @
    ...
    DT ;;;
    LJrQTHFXZFB
        `"], encodeOffsets: [[120391, 40118]] } }, { type: "Feature", id: "120111", properties: { name: "西青区", cp: [117.1829, 39.0022], childNum: 1 }, geometry: { type: "Polygon", coordinates: ["@@@LHAHRHATh`;
    LHNHDG`HDGZ`;
    D; @
    FQDAHXFACNAFLVRTBFOfHDCVBFQH; @
    HSXHEPFB; @
    LDBF[bDbLFKJBFLADBDjLvCPEI];
    FGEIGCBEUSjcFiBIVWfaHCjN ^ HtwBBFGPBJGjFBEGECGDONMFAP];;;
    TDHQOWCMGAMHKIJEIGQ];;;
    aDlUG];;;
    VGEGDC ;;;
    {
        ...
        BCA; @
        FMQCFMYMJECELCMI_P ¯;;;
        `]R±¡¸odfx\\gF@JUFFH[F@DIBGMMFaJDDQ@MCSDCBENMH"], encodeOffsets: [[119688, 40010]] } }, { type: "Feature", id: "120113", properties: { name: "北辰区", cp: [117.1761, 39.2548], childNum: 1 }, geometry: { type: "Polygon", coordinates: ["@@ROHFFGCOJEDB}DFHANDJHFEFSM_KC@O@CJ@DIRM@CEKKA
L
FKACHoLSJSIBETDJaEIIE]E]K[MYUYQILC@GF[MGNKEK@A@BCWECAIFEFYAGFOMI[OFuDiKACBCEKIAELaKaCE\\CA@KEAFOWGGTG@ERUACDeGEPSAUQKHE`
        FNjNFJADHHCJFB;
        @
        DEXZFRRBJLA; @
        AR; @@
...
HsNSiMGDebUXAJEjidVTAFHDFJ"], encodeOffsets: [[119940, 40093]] } }, { type: "Feature", id: "120105", properties: { name: "河北区", cp: [117.2145, 39.1615], childNum: 1 }, geometry: { type: "Polygon", coordinates: ["@@DBXFADB@L@LFHM\\NHED@JKZRb]QMRAFCJBDCBQYADMCAe@QIMP@GSIAIPE@E[EGH@ZEF]^HJAXK@KF"], encodeOffsets: [[119980, 40125]] } }, { type: "Feature", id: "120106", properties: { name: "红桥区", cp: [117.1596, 39.1663], childNum: 1 }, geometry: { type: "Polygon", coordinates: ["@@J\\PNHEZBFEJELEL@BWGI^]FEkA@G]A[FDHUCMNEHJ^"], encodeOffsets: [[119942, 40112]] } }, { type: "Feature", id: "120101", properties: { name: "和平区", cp: [117.2008, 39.1189], childNum: 1 }, geometry: { type: "Polygon", coordinates: ["@@DT@FCHG\\FFOROMEgYc@"], encodeOffsets: [[119992, 40041]] } }], UTF8Encoding: !0 } }), define("echarts/util/mapData/geoJson/world_geo", [], function () {
    return {
        ...
        ;
            ...
            ʙп̗ЭÔʁڜҫ٨ˏѠ́ ؈;;;
            ӻʂBѰɍŶʷߤ ˵;;; ֈ ˼
            ǐҊǠόľҤʰڞŝОÔʔīӔŌنǈǠŽ ˬ;;;
            ȮѾǆҦtʈ̸̾ʂЩÎՃȾķ ;;;
            Λ̨ёÚӇ ;;; ̥
            "]], encodeOffsets: [[[148888, -41771]], [[147008, -14093]]] } }, { type: ";
            Feature;
            ", id: ";
            AUT;
            ", properties: { name: ";
    ...
    ˀǣþƜšո̠ń̒ϰز ˓;;;
    ӀΆ̐ÚٶʱЂªϰǁãŃČ̅;
    "], encodeOffsets: [[17388, 49279]] } }, { type: ";
    Feature;
    ", id: ";
    AZE;
    ", properties: { name: ";
    ...
    FȿσМ͓ūЃȡ ;;;
    ƽû ˙;;;
    țūҥݓ͈ͅΘ͋Ȅϭ̾ǻʺЩϾǬΒ̞ȕǼǨϾnܠƓ ׈;;;
    \;
    \;
    Ϟȅ;
    "], encodeOffsets: [[19462, 45937]] } }, { type: ";
    Feature;
    ", id: ";
    BLR;
    ", properties: { name: ";
    ...
    ɷ͌ ;;;
    ϊ;
    "], encodeOffsets: [[24048, 55207]] } }, { type: ";
    Feature;
    ", id: ";
    BLZ;
    ", properties: { name: ";
    ...
    OŮĸ ;;;
    ƴı̞ Ԕ;;;
    ǄZHūǄGaɭƋεôŻĕ̝ÀăīщǓɟƱ ;;;
    Ǔ̅ʣ; @
    àॆPژ;
    "], encodeOffsets: [[-91282, 18236]] } }, { type: ";
    Feature;
    ", id: ";
    BMU;
    ", properties: { name: ";
...
͏ǙĔҿƑK؏ώ̫ƀӓoηϙᘯп҂ʣpժࡤٟϾԍị̈ƤҧɝصŀӵࢤϳɐˍІ֑Њɡā"], encodeOffsets: [[-77182, -155]] } }, { type: "Feature", id: "CRI", properties: { name: "Costa Rica" }, geometry: { type: "Polygon", coordinates: ["@@җȆǟǮĬƤȄɷȪͥǔ́ņÅʖəƮÄʑǗȩȓɸˑĊŗǞLʮŎˆʁŠȖǌŴňֆɝȖŊˊéƔǥʜÇȪǲɈҙ͖ͷЂΩ͗õLͷǪűűıƱëǟ©Ǖ"], encodeOffsets: [[-84956, 8423]] } }, { type: "Feature", id: "CUB", properties: { name: "Cuba" }, geometry: { type: "Polygon", coordinates: ["@@ܨÑڊW߄˹̭ͮ޺Ĩ̔ȡ܈ԳԺϛˢ\\ԆǟÕʁئٌ΅ıȟ֑Ń֡¥׃âளą֜Ҷ΁ɔէÈ̃ʐȥӎӃ޵ɦʥǬભž̋ǐ̀ɀࠗ¨׿ѧΏ[ťȳеğΫĂѺʸǼ̤ϞȈіǎَĄȰĢ"], encodeOffsets: [[-84242, 23746]] } }, { type: "Feature", id: "-99", properties: { name: "Northern Cyprus" }, geometry: { type: "Polygon", coordinates: ["@@ÐJŨȮ؄Yކʢ֧ΧÔƿęǇÙűj¥iĎÑ¾ǋVɫïƿ¬"], encodeOffsets: [[33518, 35984]] } }, { type: "Feature", id: "CYP", properties: { name: "Cyprus" }, geometry: { type: "Polygon", coordinates: ["@@ãࡱͿЩŊȟͶЎǀ«ɬðǌUÒ½jč¦ŲiǈÚĚ"], encodeOffsets: [[34789, 35900]] } }, { type: "Feature", id: "CZE", properties: { name: "Czech Republic" }, geometry: { type: "Polygon", coordinates: ["@@ϯǂЁ©ٵʲ̏Ùҿ΅ر˔ӃΰѕȬėΠƧʠؒǾ̸Ⱦ׾ǎɂǆɜīϒĖЊ˓ؼñ¿ɳҘǧŲɒּĥĄʿز»ϮЯʡCŽƯȕÅȑǇ¡wý˹ēϋbšȁ"], encodeOffsets: [[17368, 49764]] } }, { type: "Feature", id: "DEU", properties: { name: "Germany" }, geometry: { type: "Polygon", coordinates: ["@@d͗ࡔțS̗ࡢǂҾɰॊͧІˋȞёɹɣ̨̙Ⱥ҅ß́Έ՛ϑĕɛĬɁǅ׽Ǎ̷ȽؑǽƨʟĘΟіȫӄί̑ϯ̟ŃŢշýƛʿǤЕ~׷ƭݍţɛыɺʩ±࣑ʲǥǻ܍Nń״ьֺ௅ƸЇɘ´ςǗȐĨ֨ƗࢢԎ@Ɉ͂Ⱦޔƿ˴ǐǲ۰°Ƽȃ֮вȓ̀ӈٌōՠŸ"], encodeOffsets: [[10161, 56303]] } }, { type: "Feature", id: "DJI", properties: { name: "Djibouti" }, geometry: { type: "Polygon", coordinates: ["@@ȤʹΑӏȩήɯ̱҇ȅƬȭÏҷb_ʮßɶ˴Ѐ̐ϊήñʪȴ"], encodeOffsets: [[44116, 13005]] } }, { type: "Feature", id: "DNK", properties: { name: "Denmark" }, geometry: { type: "MultiPolygon", coordinates: [["@@ԋڹ࢟ӄŝΒ௼˨ˎу"], ["@@ȵ̓ʡĞ؁؁ɮХ՟ŷًŎͽҲ}࡬Ɣɪʌʦ݌À̐ɴڮʂѝʟ˙ĶɽҘŵ"]], encodeOffsets: [[[12995, 56945]], [[11175, 57814]]] } }, { type: "Feature", id: "DOM", properties: { name: "Dominican Republic" }, geometry: { type: "Polygon", coordinates: ["@@ŀƞپIӾɏɜtƴ̕ҠhʡϐЮ̷̯ͿЍǼϫˡ¢ƱƵ͑½ŷȲˣťͳֻɏƆ§ʎjɬɍʦȲƚÞ͒óҜ"], encodeOffsets: [[-73433, 20188]] } }, { type: "Feature", id: "DZA", properties: { name: "Algeria" }, geometry: { type: "Polygon", coordinates: ["@@ᮩཽᝩ࿷இϑटćU՘ϵƌԹʊȧЀᬻᆴᬻᆴṕᎠfǌ@ÊQ঺ബب࠼Ÿێɦ͎тচͪجӢòϞ̶સƚƸ͜ɛǲ̃ࢲ¹Ԟ́ՠ߰ҠࣦƢՌΎ߶ʰ෎Ƭർæшůߊͨ࣌P΀ȝֺ¾ǟћƄߟȡۙԭҵôمۊԃRȯԮ͹Ϊຝ˖ݏ°ϵƧۇÔϥŃҟòՇͫΗӺؓέ̘ҵϼƸڒϷςՃ"], encodeOffsets: [[12288, 24035]] } }, { type: "Feature", id: "ECU", properties: { name: "Ecuador" }, geometry: { type: "Polygon", coordinates: ["@@҂غǻξ͍ϵԉςǞʀƙބ̎ŴƺԼ͆զÍ΄ҢǸ׀Ͱࡀӑƾ`;
    ...
    ڨȣټ ³;;;
    аɄւ ෽;;;
    "], encodeOffsets: [[35761, 30210]] } }, { type: ";
    Feature;
    ", id: ";
    ERI;
    ", properties: { name: ";
    ...
    Ǭę ʹ;;;
    β ఀ;;;
    Ċ֒ˆʴؤƐьӒӦঃɴޗҢУବߏҲӍҖӝˀ ˿;;;
    аʧʩȳέò;
    "], encodeOffsets: [[43368, 12844]] } }, { type: ";
    Feature;
    ", id: ";
    ESP;
    ", properties: { name: ";
    ...
    ΫˉۙDܡ̸ρļ ܏;;;
    Ʃ;
    "], encodeOffsets: [[24897, 59181]] } }, { type: ";
    Feature;
    ", id: ";
    ETH;
    ", properties: { name: ";
...
},
{
    ...
    geometry: {
        type: "Polygon", coordinates: ;;;
        ["@@҅ΘΝÈȕʀLŸʯǴÁǶѼƌ˦ɦĨ༈c˵ġĕð˧ƃōȃCɕƗʭfύХ"], encodeOffsets: ;;;
        [[-15493, 11306]];
    }
},
{
...
},
{
    ...
    geometry: {
        type: "Polygon", coordinates: ;;;
        ["@@ћƦԻfϩǖҍΌrʖĮȠšƾКۆ઄Ft˸Ƌ¾ġǺ̵Ț̹ˬϜDBӂ޸BަUOڗßॅʤ@˚ƱòŰʘŃϥ͍ЉɻÏǉâǑǧɇȟ½¬ıƿġ˽Ƀ}ŭ"], encodeOffsets: ;;;
        [[-92257, 14065]];
    }
},
{
    ...
    geometry: {
        type: "Polygon", coordinates: ;;;
        ["@@͉͑ГÑŗʀȉʹɩνǦɈΪòϤƢή͛ӸáֺѪܠ˸ğؤȥࢸۿƔ·ӻޑʳأ"], encodeOffsets: ;;;
        [[-53817, 2565]];
    }
},
{
    ...
    geometry: {
        type: "Polygon", coordinates: ;;;
        ["@@ր̯Դյzџ̈́o҈Чͪ̇Ƈݱԛɕ°ȣƹџϊ؏ːAŎӃԢܳȱҫî˙ɡϟƥ˅ġǑЭ¦ԫЀÓϴɋьƆܐɸ̐ȕϸ˿ŶŊτțȘѩْ֩ɬɲiϲԬƊȾƾ˽̸ô̬ږӲ"], encodeOffsets: ;;;
        [[-61192, 8568]];
    }
},
{
...
},
{
    ...
    geometry: {
        type: "Polygon", coordinates: ;;;
        ["@@Ȳ͗ˊʇ͓̓ϝȆׇ[ܟƔϽmǻǧ̝ȖǫΑЪϽǼʹϮ̽͌ȃ͆Ηݔ͇ġƛ߃̶ӣ̢ޑʠ۹ؤǞØϥΞe˲եƄʱγʝˮn̆bג;;;
        Ƹƚ ˸;;;
            ƍͤgGɼ̈ĒĈͺڞɠˊĻ ؼ;;;
            έۜǉ̼Ų;
            "], encodeOffsets: [[19282, 47011]] } }, { type: ";
            Feature;
            ", id: ";
            HTI;
            ", properties: { name: ";
        ...
        ʾö ˔;;;
        ޜśيã̢ȈϧθP͎ՋžȌɶ;
        "], encodeOffsets: [[-74946, 20394]] } }, { type: ";
        Feature;
        ", id: ";
        HUN;
        ", properties: { name: ";
        ...
        ήˉļǍ ˴;;;
        ƗV;
        "], encodeOffsets: [[16592, 47977]] } }, { type: ";
        Feature;
        ", id: ";
        IDN;
        ", properties: { name: ";
    ...
    õФՏɁ ਱;;; 
    ಟ;
    "]], encodeOffsets: [[[123613, -10485]], [[127423, -10383]], [[120730, -8289]], [[125854, -8288]], [[111231, -6940]], [[137959, -6363]], [[130304, -3542]], [[133603, -3168]], [[137363, -1179]], [[128247, 1454]], [[131777, 1160]], [[120705, 1872]], [[108358, -5992]]] } }, { type: ";
    Feature;
    ", id: ";
    IND;
    ", properties: { name: ";
    ...
    ܒӠڳд֪݂̇̕Ьβ ౤;;;
    ȱपŰߺ۸;
    "], encodeOffsets: [[79706, 36346]] } }, { type: ";
    Feature;
    ", id: ";
    IRL;
    ", properties: { name: ";
    ...
    ǌװӔ֚;
    {
        ...
        у ஠;;;
        ƟಾɞĄȞ;
        "], encodeOffsets: [[55216, 38092]] } }, { type: ";
        Feature;
        ", id: ";
        IRQ;
        ", properties: { name: ";
        ...
        ҢȺјԾΰž ঎;;;
        Ň̐ɉЖƚծ ৉;;;
        "], encodeOffsets: [[46511, 36842]] } }, { type: ";
        Feature;
        ", id: ";
        ISL;
        ", properties: { name: ";
        ...
        ʘᄋȜ֨նౠŰಸ֭౨Ҝ ੒;;;
        ʃൌ҄ආÑ;
        "], encodeOffsets: [[-14856, 68051]] } }, { type: ";
        Feature;
        ", id: ";
        ISR;
        ", properties: { name: ";
...
ЙҋԁȥԝƸƥűγɁٽɅɎǭcǃY̝ԓƳĲķPŭޥV޷AAӁϛC̺˫̶șĢǹƌ½s˷ઃEЙۅŢƽĭȟqʕ्ࣞџ˘ۇɖҷÓګ́чĉץɜؿǄ޹ϬؿŠ्ϸ۱ВɃɤҹº࡯ˈΓϦࣗӊсՌȧЦ˪ĈđʈȖɔJ̄˱Ϙùͮ˭ъ݋࠴ࡋڀУԼܝ΄ƷȴŸԲѓȞӹФȽהҍæӣѸϿФˀҍو̓٠^͔؇ͬ˫ӑɴƇͿƔЕĆف̀΋خׁƒȡŸÓŎ˽Ƭ\\ǜթʮɇǴ̕Նё˨ޯʠρɸϿ²ѷКͶϡ̨ϑqƭΝ̱ƫJɛԞջӎ؃РїɈؚŵҖЏʺֿϒŏŇɃɖԭȰӷӦÖÚΊ³̸̼Ϝ٩׶ӱɶ̱Հ̷վϳڦͿݲॖÞ੪ĞÿǑ౔СኀףဪPژ@DΌผ@̪̕јˇԀσ˨ѭȾҥѢʩۤʥՊڒۊhפͱфֹ̄ӯӸӏȂחɾЃپʹ׮ȁ͞|"], encodeOffsets: [[-99471, 26491]] } }, { type: "Feature", id: "MKD", properties: { name: "Macedonia" }, geometry: { type: "Polygon", coordinates: ["@@ńOǤӺżȊ˺¶ϴbтˏÒ։ǅƑƥҕh͋ǿջõΑȴšήń˸"], encodeOffsets: [[21085, 42860]] } }, { type: "Feature", id: "MLI", properties: { name: "Mali" }, geometry: { type: "Polygon", coordinates: ["@@˰ƶƘӶˊpזɻӄǖ͖ÇŴȈ⁚^ȈךƣļЛ⋈Л⋆౾dᬼᆳᬼᆳȨϿԺʉ϶ƋV՗ठĈFካҟ֗íԭݛƃ଩ï̳̗ա՟Iȿǈҥš޻ΑǅʿٳϕŗɍΙǡНŔɱȳūֻڙۡp˳ɭΣÆӥ΋ůȝŁŽάʍĥơhƷʕ٭PɷŴŉùʱʎ¬ʢĿİǳĉ˚Ǥɐ΅ΚĳɴȇȂǙvȫş˕őɱǹΫäɷɈƓɕőƅAµ̮ʾí̽͘ʀǓӔԺ"], encodeOffsets: [[-12462, 14968]] } }, { type: "Feature", id: "MMR", properties: { name: "Myanmar" }, geometry: { type: "Polygon", coordinates: ["@@ӫηץϥࣥΟƳО݅ՔؗΈօ̭ܵ̃ƹȪу֖ڙĪҷ_ϵ͠ދң޵Сࡷăذʴ٠˯ӼæࣸͽѤ˛৔Ʊਗ਼εۢօуॕ׳ҽöԳȠ̂ਪǫ޾څॺļ̢ӭņ׭ۆÅڰ̊ŵj׾дȦęΤȐ˺࢈ڂȑϐۘ¨ЦҪ۶}Ӕજ׆׸ƱçԬ̎ƸÛ͈ӮÚˮӵξȧ|ٟۙߓۭĳঽࢲƔȨޛՐǍʓۣز́ζƷ؞ʔ~΍܏յǳ̱ӓȗ"], encodeOffsets: [[101933, 20672]] } }, { type: "Feature", id: "MNE", properties: { name: "Montenegro" }, geometry: { type: "Polygon", coordinates: ["@@ÁǀηЯÊˋǫÞɽ˞εǖĢƜŬҦ˚ȜƾüɠƟŬśˠě͌ǧçïƽȋɧó"], encodeOffsets: [[20277, 43521]] } }, { type: "Feature", id: "MNG", properties: { name: "Mongolia" }, geometry: { type: "Polygon", coordinates: ["@@ࢮƢ྄ܤ౬Єܴʳ࢚]֘Ͻ࠼ௐɁࠈגͿӶࢊࢊश΍ނįনɍǈؿஜΛߐƺਫ਼ŌࡆōࠖЗԚѕެT੒Ƌޜȼૈƒ௸פԌĝѰ˭ৌêХهק࠽ɐ΅ӈńࠤŽ٦̴ڬˏހוğ̗ڏĦ௟ŏןʅ؝։౱͙࠷ѽࡹǞҿúѳէˎ͓ƌˣי˯׽҇গ̑ఽഫ̇এҋϋʾ৭AఓԜࠥŰૣśჃȊऑmӱԀϣޠԱĢ৩ԼଅŞুƞ̡θ͖চׅڲன̀۷Ѿəז"], encodeOffsets: [[89858, 50481]] } }, { type: "Feature", id: "MOZ", properties: { name: "Mozambique" }, geometry: { type: "Polygon", coordinates: ["@@لæ৞ʁɖńגt̚ʦԌaऀ͜ڞӤƊϕ࠷ľ݅ಿƨЫʣ׷͙׍՗Եޏ͉ृСॉ͓ࣕƵוׯ΋ȗí׳ЌُǔӱZʣƪ¦{ࠗƋϷȤƝűΓΗ̗ۗ˳য়ҕρ̳ðΟɊÉíѵّRïϊůϖí̠ƬपɓװГஂࢬ॔ɜ؆ŶúĨӶƉʞغǐ׌E੠ѥ˒ЏÔǹȼϳǰ۫gÅ̼āװᢈۘӚЕɴüͨɅ¸͵ǯϷØסոԱʲ׌ζǰíઊΙ؈̣˖̅]ɽદɾٔ"], encodeOffsets: [[35390, -11796]] } }, { type: "Feature", id: "MRT", properties: { name: "Mauritania" }, geometry: { type: "Polygon", coordinates: ["@@և־ԗؤ֍ɞГʚҵUЧǽйð˽ˏïҐɺаŀߊģࠨĵкČмɑЎѵδǾˬᾔMǃ௎ȴќ߀øᒸ᪂©F౞Ṗ᎟౽cМ⋅М⋇ƤĻȇי⁙]ųȇ͕ÈӃǕוɼˉoƗӵ˯Ƶ"], encodeOffsets: [[-12462, 14968]] } }, { type: "Feature", id: "MWI", properties: { name: "Malawi" }, geometry: { type: "Polygon", coordinates: ["@@ɽٓɾથ̆^̤˕Κ؇îઉεǯʱ׋շԲ×עǰϸ·ͶͧɆɳûәЖѵɔʮޮ˄̈Ǉۢǚڼƞɪɉ܌Ѕϐ࠘ƽǜɵ˶Ϲɾଡ"], encodeOffsets: [[35390, -11796]] } }, { type: "Feature", id: "MYS", properties: { name: "Malaysia" }, geometry: { type: "MultiPolygon", coordinates: [["@@àћֈĶ˞ΈȘýӸԓΜ֛¶֣ęϡĆ˿Öӻ̒ɵͤݑe˳׫Éߑخ঵ښįђӟ֚ś̡۠ҜĠؔȃΤƤƮۈρ"], ["@@أ˹ܯƚॱ@̅ॗ͓̇љୟۅǵߑɾЕóөщ՛Òէǟַӆƕ֘؜˽ٮǀǜ܆άǂ৖Ǻ׾ڔЬՐϦѥǮ˺В¸՜а٪אшڀͼHќыιֆɻ۬ʧÑ֝͡¥ƮЧ"]], encodeOffsets: [[[103502, 6354]], [[121466, 4586]]] } }, { type: "Feature", id: "NAM", properties: { name: "Namibia" }, geometry: { type: "Polygon", coordinates: ["@@رٌؖ͡ȃࠊȷ،˯ಒm৒ŅҞ͛Όѡۜѳ৘ǽՆۃࠐ»٢КǆԊƞհ}ԄϝŶÐ₮׌Е᎞ş໴΂یȒհµͨȍPéӁȍʭC՛͍ͣΎಕ̍س{ᲽࠣBយA᷋ݣѕҋÕՇǄϗÔƗάͩɰГг"], encodeOffsets: [[16738, -29262]] } }, { type: "Feature", id: "NCL", properties: { name: "New Caledonia" }, geometry: { type: "Polygon", coordinates: ["@@ېԵѨϭ͉ȫҥɪ׹ϚէѼ։פś˶β[Һ˹φ˷ˎɻ"], encodeOffsets: [[169759, -21585]] } }, { type: "Feature", id: "NER", properties: { name: "Niger" }, geometry: { type: "Polygon", coordinates: ["@@nּॹȐОҿպœϤâТբ̴̘ପðݜƄîԮҠ֘Eኬஈϒᝪ࿸᮪ཾ೨αӀңר̸ȸಯ̾ɓ`;
    ...
    Ο ˄;;;
    сϜĤžƒŵÚÒʾ ;;;
    ŀȔŬRkЮȠrǬOǺɤʜǝĒľƺĲ̊ɴbǦĄQňȪĖ | ƜŹǚ ;;;
    ȆńɄB̈ŌŜŖ ˾;;;
    iïă §;;;
    ȉĐ̫ȗ ˹;;;
    ě ͷ;;; 
    ...
    ɏtϙŹĉýΫÌɛǣɋ;
    ɩźƏȩǱʛÈƓǦˉêȕŉօɞųŇ;
    "], encodeOffsets: [[-87769, 11355]] } }, { type: ";
    Feature;
    ", id: ";
    NLD;
    ", properties: { name: ";
    ...
    ȫ ࡘ;;;
    ʤᑺȽ;
    "]], encodeOffsets: [[[28842, 72894]], [[25318, 79723]], [[18690, 81615]], [[26059, 82338]]] } }, { type: ";
    Feature;
    ", id: ";
    NPL;
    ", properties: { name: ";
    ...
    շҾť ˰;;;
    ЕٶǓۀσौȕঔć;
    "], encodeOffsets: [[90236, 28546]] } }, { type: ";
    Feature;
    ", id: ";
    NZL;
    ", properties: { name: ";
    ...
    ʔ ˺;;;
    ľñā ΍;;;
    "]], encodeOffsets: [[[60274, 21621]], [[57745, 26518]]] } }, { type: ";
    Feature;
    ", id: ";
    PAK;
    ", properties: { name: ";
    ...
    ऩů ౣ;;;
    ȲЫα̖݁̈֩ڴгܑӟ
        `׳ࠃࡇՃ࡝࢝ࢡউÚऑࢡռϗĪ٧ҾэǘܝᇛD֓֕؛Ɇʣ؀٭٘໻ǁിeஃŝ̈́ঊொѢéϰГƌw݊ߥφͷԔеѶඨѕࡀŲԈŅǞȂגóદΔ܎ҶӈشCĠɼٞŌ̴ý͢ʀ±ԌΦԖ՘Ɇͥ֊ߜɴ̢͒мΜĩмȣΤӬμࣘǮ८ĮѐƺӨĦ"], encodeOffsets: [[76962, 38025]] } }, { type: "Feature", id: "PAN", properties: { name: "Panama" }, geometry: { type: "Polygon", coordinates: ["@@˫ʎǵҒȺɢɅÎƿˤлɸοÁǝ̇ͻɁǽĉǩВҗɯŅŧŭϷ©ơԈŋƛˡ¸ǝ͸·ÈɓİέCǻĩŶªǖìǠƲŲĲǩŲK͸͘ö̠̝iǱͲĀæɴȵЮÔΨɄԜǞ˺ʤҬ·ĉҶ
...
Śǥ࠶@ǦѠǄĒʔ͆ǦۺөѠĒм؆ҤҤïԎȫʖԎªÎȈϴËĵاĶ؃ѠͧĶ˿cлŜg"], encodeOffsets: [[34779, 9692]] } }, { type: "Feature", id: "SEN", properties: { name: "Senegal" }, geometry: { type: "Polygon", coordinates: ["@@΍ٺн̚φǄРמȦќ˾ːкïШǾҶVДʙ֎ɝԘأֈֽԹǔӓ̾ɿî͗ʽŧ³қâÙģȃk׿ȲЛV༇ɥħ˥ѻƋƏ٢ވkȬŞƮR̸ȘήǯκcζȌǝʐˡƙʻJͧȸˉ_ȍȥࣵy"], encodeOffsets: [[-17114, 13922]] } }, { type: "Feature", id: "SLB", properties: { name: "Solomon Islands" }, geometry: { type: "MultiPolygon", coordinates: [["@@ɾ˿חN͉ԬԈȯǜ"], ["@@͝mԧĎǫżÀͮֈƁ˜ǭƎə"], ["@@ųƹحܰǫԈ˺@̠ڥʹЗ"], ["@@ǛڅΦҟ̠̿˪ŰĐϮȫېϭȢˉ"], ["@@Ǘ³οȒ·Ί¨ƖԈΡͰ˛"]], encodeOffsets: [[[166010, -10734]], [[164713, -10109]], [[165561, -9830]], [[163713, -8537]], [[161320, -7524]]] } }, { type: "Feature", id: "SLE", properties: { name: "Sierra Leone" }, geometry: { type: "Polygon", coordinates: ["@@ɧØ؁ͺѩ҈Ƨ̬Ĺت҆τĬɺƞǸɶpȜǂڦCɺ̛ǼΛʓƈɗṶɴ´ϹϹϛҗ«ʓȩˏ"], encodeOffsets: [[-11713, 6949]] } }, { type: "Feature", id: "SLV", properties: { name: "El Salvador" }, geometry: { type: "Polygon", coordinates: ["@@ġȡӡ^̡Ą΍ǘұÀʃǶ~Ů˾ɄǀĢ«ĲȠ¾ʜëǸǙʪƇœτĴǤÑŘĝÏͳ"], encodeOffsets: [[-89900, 13706]] } }, { type: "Feature", id: "-99", properties: { name: "Somaliland" }, geometry: { type: "Polygon", coordinates: ["@@ϛԩד۫۹Mᩧা͍̜̳К̳ҨǾ̖̲҈˚ƹǒΏϜΗкGߊɌࣴĴ݌ʼиÆ̚ƶӎKaE΋Aࡑ@ѫ"], encodeOffsets: [[50113, 9679]] } }, { type: "Feature", id: "SOM", properties: { name: "Somalia" }, geometry: { type: "Polygon", coordinates: ["@@ѼĎЊ˾͈FpɵýӧHѳǯ̣ʁࣥЙयԱ੷ܝ௷ܓवধ଩ࡁڹష࠯޳ٕँৱȗѷȍȣӽۚWᵤܾ॒ɰˆբfݠפબᛜᡄה۬ϜԪ@ѬBࡒFΌLbːhϰŰ"], encodeOffsets: [[50923, 11857]] } }, { type: "Feature", id: "SRB", properties: { name: "Republic of Serbia" }, geometry: { type: "Polygon", coordinates: ["@@Ԡȡà΋Ӫʓ˄ȌȸĿșƗƶƥȷȏø̫Тγ͋ʿƗˋĞĳƑšϳa˹µØĴĴĦȴšKǍƼƑ ŋƆƽÀšŠƯ±ś˧ȩÑèð͋Ǩ˟ĜūŜɟƠȢŬЄЛ͔ɀτ̥Ë͔́ˉʈȱ͘٢ɚԾҖͣĦˋ"], encodeOffsets: [[21376, 46507]] } }, { type: "Feature", id: "SUR", properties: { name: "Suriname" }, geometry: { type: "Polygon", coordinates: ["@@৔ǙĞưڶÔࣚɥѩܟâֹͤӽƥίóϩɉΛӓǲЇđ͹öčʏƘǗ÷ǡҙèԡܴōӄˏBωؐƺѠ¯ȤԜɖƈݲ"], encodeOffsets: [[-58518, 6117]] } }, { type: "Feature", id: "SVK", properties: { name: "Slovakia" }, geometry: { type: "Polygon", coordinates: ["@@´»ΊŖш̕ӺǶЈđ؂Ţߚ͓ɷɓǏ͹ǳđ࣑ʮ˟»ȟȡЁĿěÄХŽͭ}ãǙ۷Ļ̱ĠёɌċ̆äńŢȂόa˺Ĕxþǈ¢ÆȒȖžưʢD"], encodeOffsets: [[19306, 50685]] } }, { type: "Feature", id: "SVN", properties: { name: "Slovenia" }, geometry: { type: "Polygon", coordinates: ["@@ۜÝъȐܾtǈƘƘUǎ˳ڝɟć͹̇đHɻͣh˷ƎƷƙבȈúȫΨĞа"], encodeOffsets: [[14138, 47626]] } }, { type: "Feature", id: "SWE", properties: { name: "Sweden" }, geometry: { type: "Polygon", coordinates: ["@@ࠁוƀԥ೹ڭྱܡؓஃײףߦүޗॅ࢑ȝ͍තӋ޿৳ĆӅڗঃˉߐ۳॔ٓஐφӜּۨ˦ন՝ю½ૠղ߀࠰ä̧ͬ˺ಬஂࡀञֈײ߮GɞҶཔƉŬքԸ૪Щ಼ֱv಑˴͛ฃʃ"], encodeOffsets: [[22716, 67302]] } }, { type: "Feature", id: "SWZ", properties: { name: "Swaziland" }, geometry: { type: "Polygon", coordinates: ["@@ǡύӭěԅҖS̄ɰ̀ĂʔʐÒшƵŰϕðω"], encodeOffsets: [[32842, -27375]] } }, { type: "Feature", id: "SYR", properties: { name: "Syria" }, geometry: { type: "Polygon", coordinates: ["@@࿩ࣅऩͬgNŖŶ_ΈȸҠҜ̈́Əͤϗ¨ÿٞȶΌɤȀɤȀ°Ҹ˞Ǐऎɺ҂ƿۖFॴ̀Ґaक़žїԽҡȹĂؗͅ৫ᇵ࢓"], encodeOffsets: [[39724, 34180]] } }, { type: "Feature", id: "TCD", properties: { name: "Chad" }, geometry: { type: "Polygon", coordinates: ["@@ĎЄաnDզΓ̶δ૊ੴߌ¬ન͖ၼǼΰΓ˾_ˌ̽ɔȷರࡔҠ…ྑ…ྏ¦ ܥÐϧإɝԯǬȝˡʳĨΏɑΕč̯̎¶Ǯ͕Vӥ̲ʛYȯՏƛэͽ؉ࣹ߅ϳ߹¾ʁûĊ̏ѫ̋Σ͟੓͏ȽȐƓhƹɍۛÙƀɪ˅ׄşΐλƜӷӪǼІϦċʂÐҸSқކ֐É֐ͭՠ"], encodeOffsets: [[14844, 13169]] } }, { type: "Feature", id: "TGO", properties: { name: "Togo" }, geometry: { type: "Polygon", coordinates: ["@@ڱǳȇ̎ɡՔãкȆݴɁ̬ăڎD؎ΕѠÖˀ݂kŅѵʲʝ̈̋ЭǜǥኝȺׅ"], encodeOffsets: [[1911, 6290]] } }, { type: "Feature", id: "THA", properties: { name: "Thailand" }, geometry: { type: "Polygon", coordinates: ["@@ݭϬܗeŬڈ݉Káऋґ௯˙ݏÌ؋ն΀ދưܭҶӓԚĭѤѧ˝·ևĵßќۇςƣƭͧ͒ƝжҁӄПЌƏӳǃҲĠԾʚ߬ТࡸҤ޶͟ތ`;
    ...
    Ŧગǅ ՟;;; ۧ
    Ȥ১;
    "], encodeOffsets: [[105047, 12480]] } }, { type: ";
    Feature;
    ", id: ";
    TJK;
    ", properties: { name: ";
    ...
    ЌҬˌբ ૲;;;
    ȜǩϵŤɹΎv;
    "], encodeOffsets: [[72719, 41211]] } }, { type: ";
    Feature;
    ", id: ";
    TKM;
    ", properties: { name: ";
    ...
    Ѕɤſ̙ ۽;;;
    ǋǙڥӁʭڏŵǫϟهŏ ࡩ;;; ͈
    "], encodeOffsets: [[62680, 36506]] } }, { type: ";
    Feature;
    ", id: ";
    TLS;
    ", properties: { name: ";
    ...
    ӚŊǮ ;;; 
    صۭġƯúʒɲiͪ;
    "], encodeOffsets: [[-63160, 11019]] } }, { type: ";
    Feature;
    ", id: ";
    TUN;
    ", properties: { name: ";
...
ы ܊;;; ̲
ÒǉпЫMϱ̆ȽōܫփхǄқѤaɄЍ͊ſ ³;;; ٥
Хʋʵˏֽ͓ĘΑïΟЧț;
"], encodeOffsets: [[9710, 31035]] } }, { type: ";
Feature;
", id: ";
TUR;
", properties: { name: ";
...
Ƶȵি ±;;;
Ωʷ;
"]], encodeOffsets: [[[37800, 42328]], [[27845, 41668]]] } }, { type: ";
Feature;
", id: ";
TZA;
", properties: { name: ";
...
ɲˎÑƮǬäĊśӸ;
{
    ...
    ղĚ ࡆ;;;
    ٯ̺ |  ࡺ;;; ՟
    ڈҫӠֱχЉɸӇεՇॉұاǚғěޥΰ֫ ;;; ԟ
    ҬÞլǾȈS ࠸;;;
    ɤ ࡺ;;;
    Ⱦڦ;
    "], encodeOffsets: [[-59008, -30941]] } }, { type: ";
    Feature;
    ", id: ";
    USA;
    ", properties: { name: ";
    ...
    ЕǄ ˹;;; ͝
    {
        ...
        Iⷍ ࠠ;;;
        {
            ...
            ĪཪώޜÉಐ҄ ౚ;;;
            ǭ;
            "]], encodeOffsets: [[[-159275, 19542]], [[-159825, 21140]], [[-160520, 21686]], [[-161436, 21834]], [[-163169, 22510]], [[-97093, 50575]], [[-156678, 58487]], [[-169553, 61348]], [[-175853, 65314]], [[-158789, 72856]]] } }, { type: ";
            Feature;
            ", id: ";
            UZB;
            ", properties: { name: ";
            ...
            ȧǺصҿ ࡗ;;;
            هǰҳN;
            "], encodeOffsets: [[68116, 38260]] } }, { type: ";
            Feature;
            ", id: ";
            VEN;
            ", properties: { name: ";
            ...
            ǬĴ̶áͺȃȂŅϮѡÈɸӮĺ ׶;;;
            ʔ̸͘ʌɈрդƖ;
            "], encodeOffsets: [[-73043, 12059]] } }, { type: ";
            Feature;
            ", id: ";
            VNM;
            ", properties: { name: ";
            ...
            Ĭܒ҄К̿ސƵƃӛА Ϳ;;; ࡎ
            ɓ;
            "], encodeOffsets: [[110644, 22070]] } }, { type: ";
            Feature;
            ", id: ";
            VUT;
            ", properties: { name: ";
            ...
            ƌڱɥŀǩ ­;;;
            ťɴi٢Дʵ;
            "]], encodeOffsets: [[[171874, -16861]], [[171119, -15292]]] } }, { type: ";
            Feature;
            ", id: ";
            PSE;
            ", properties: { name: ";
            ...
            ŭʙЃŕ ;;;
            ɜɌŚɁĦǬ̤֔ś;
            "], encodeOffsets: [[36399, 33172]] } }, { type: ";
            Feature;
            ", id: ";
            YEM;
            ", properties: { name: ";
            ...
            ċД ஁;;;
            ɔ ׯ;;;
            ƫऩî̟чƶʏÑāʓɯ̿T̃ԆҕӮĜǢώْQȿؑıۥɑϛֵщ;
            ", "; @@
            νʶϻǟҕ҃͡Տـ٧̜ČƺˎҴƀƜ ˜;;;
            ʴФ̅ʪ;
            "], encodeOffsets: [[32278, -29959], [29674, -29650]] } }, { type: ";
            Feature;
            ", id: ";
            ZMB;
            ", properties: { name: ";
            ...
            Ǐ ׋;;; 
            عƊʝħӵŵùɛ ؅;;; ࢫ ॓
            "], encodeOffsets: [[31941, -22785]] } }], UTF8Encoding: !0;;;
        }
    }),
