...
plupload.addI18n({
    ...
    "Add files to the upload queue and click the start button.":
        "Lisa failid üleslaadimise järjekorda ja klõpsa alustamise nupule.",
    "Filename": "Failinimi",
    ...
    "Upload element accepts only %d file(s) at a time. Extra files were stripped.":
        "Üleslaadimise element saab vastu võtta ainult %d faili ühe korraga. Ülejäänud failid jäetakse laadimata.",
