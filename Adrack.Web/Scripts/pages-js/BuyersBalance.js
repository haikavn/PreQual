            ...
            $("#tbl_" + objID).dataTable({
                ...
                "fnDrawCallback": function (oSettings) {
                    ...
                    if (jsonD != undefined && jsonD.recordsSum != undefined) {
                        footerStr = "";
                        fields.forEach(function (item, i, arr) {
                            footerStr += '<td style="font-weight:bold; text-align: right; width:12.5% "><p>' +
...
$(function () {
    var dtNow = new Date(BuyersBalanceParams.timeZone);
    ...
    $("#AllBuyersList").change(function () {
        ...
        GenerateGridBalance("GridView_BuyersBalances",
            "/Management/Accounting/GetBuyersBalanceAjax/?" + dataParam,
            "Buyer Name, Initial Balance, Sold Sum, Invoiced Sum, Payment Sum, Balance, Final Balance, Credit");
    });
